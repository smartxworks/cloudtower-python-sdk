...
class LogCollectionWhereInput(object):
    ...
    def __init__(self, _and=None, cluster=None, hosts_every=None, hosts_none=None, hosts_some=None, id=None, id_contains=None, id_ends_with=None, id_gt=None, id_gte=None, id_in=None, id_lt=None, id_lte=None, id_not=None, id_not_contains=None, id_not_ends_with=None, id_not_in=None, id_not_starts_with=None, id_starts_with=None, local_id=None, local_id_contains=None, local_id_ends_with=None, local_id_gt=None, local_id_gte=None, local_id_in=None, local_id_lt=None, local_id_lte=None, local_id_not=None, local_id_not_contains=None, local_id_not_ends_with=None, local_id_not_in=None, local_id_not_starts_with=None, local_id_starts_with=None, log_ended_at=None, log_ended_at_gt=None, log_ended_at_gte=None, log_ended_at_in=None, log_ended_at_lt=None, log_ended_at_lte=None, log_ended_at_not=None, log_ended_at_not_in=None, log_started_at=None, log_started_at_gt=None, log_started_at_gte=None, log_started_at_in=None, log_started_at_lt=None, log_started_at_lte=None, log_started_at_not=None, log_started_at_not_in=None, _not=None, _or=None, owner=None, owner_contains=None, owner_ends_with=None, owner_gt=None, owner_gte=None, owner_in=None, owner_lt=None, owner_lte=None, owner_not=None, owner_not_contains=None, owner_not_ends_with=None, owner_not_in=None, owner_not_starts_with=None, owner_starts_with=None, path=None, path_contains=None, path_ends_with=None, path_gt=None, path_gte=None, path_in=None, path_lt=None, path_lte=None, path_not=None, path_not_contains=None, path_not_ends_with=None, path_not_in=None, path_not_starts_with=None, path_starts_with=None, progress=None, progress_gt=None, progress_gte=None, progress_in=None, progress_lt=None, progress_lte=None, progress_not=None, progress_not_in=None, size=None, size_gt=None, size_gte=None, size_in=None, size_lt=None, size_lte=None, size_not=None, size_not_in=None, started_at=None, started_at_gt=None, started_at_gte=None, started_at_in=None, started_at_lt=None, started_at_lte=None, started_at_not=None, started_at_not_in=None, status=None, status_in=None, status_not=None, status_not_in=None, witness=None, local_vars_configuration=None):  # noqa: E501
        ...
        self.log_ended_at_gt = log_ended_at_gt
        self.log_ended_at_gte = log_ended_at_gte
        self.log_ended_at_in = log_ended_at_in
        self.log_ended_at_lt = log_ended_at_lt
        self.log_ended_at_lte = log_ended_at_lte
        self.log_ended_at_not = log_ended_at_not
        self.log_ended_at_not_in = log_ended_at_not_in
        self.log_started_at = log_started_at
        self.log_started_at_gt = log_started_at_gt
        self.log_started_at_gte = log_started_at_gte
        self.log_started_at_in = log_started_at_in
        self.log_started_at_lt = log_started_at_lt
        self.log_started_at_lte = log_started_at_lte
        self.log_started_at_not = log_started_at_not
        self.log_started_at_not_in = log_started_at_not_in
        self._not = _not
        self._or = _or
        self.owner = owner
        self.owner_contains = owner_contains
        self.owner_ends_with = owner_ends_with
        self.owner_gt = owner_gt
        self.owner_gte = owner_gte
        self.owner_in = owner_in
        self.owner_lt = owner_lt
        self.owner_lte = owner_lte
        self.owner_not = owner_not
        self.owner_not_contains = owner_not_contains
        self.owner_not_ends_with = owner_not_ends_with
        self.owner_not_in = owner_not_in
        self.owner_not_starts_with = owner_not_starts_with
        self.owner_starts_with = owner_starts_with
        self.path = path
