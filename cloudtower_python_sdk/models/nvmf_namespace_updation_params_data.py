...
class NvmfNamespaceUpdationParamsData(object):
    ...
    def __init__(self, assigned_size=None, name=None, bps_wr_max_length=None, bps_wr_max=None, bps_rd_max_length=None, bps_rd_max=None, bps_max_length=None, bps_max=None, iops_wr_max_length=None, iops_wr_max=None, iops_rd_max_length=None, iops_rd_max=None, iops_max_length=None, iops_max=None, bps_wr=None, bps_rd=None, bps=None, iops_wr=None, iops_rd=None, iops=None, nqn_whitelist=None, local_vars_configuration=None):  # noqa: E501
