...
class IscsiTargetCreationParams(object):
    ...
    def __init__(self, stripe_size=None, stripe_num=None, replica_num=None, thin_provision=None, cluster_id=None, name=None, bps_wr_max_length=None, bps_wr_max=None, bps_rd_max_length=None, bps_rd_max=None, bps_max_length=None, bps_max=None, iops_wr_max_length=None, iops_wr_max=None, iops_rd_max_length=None, iops_rd_max=None, iops_max_length=None, iops_max=None, bps_wr=None, bps_rd=None, bps=None, iops_wr=None, iops_rd=None, iops=None, initiator_chaps=None, chap_secret=None, chap_name=None, chap_enabled=None, description=None, iqn_whitelist=None, ip_whitelist=None, local_vars_configuration=None):  # noqa: E501
