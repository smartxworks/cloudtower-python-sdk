...
class View(object):
    ...
    def __init__(self, cluster=None, entity_async_status=None, graphs=None, id=None, local_id=None, name=None, time_span=None, time_unit=None, local_vars_configuration=None):  # noqa: E501
