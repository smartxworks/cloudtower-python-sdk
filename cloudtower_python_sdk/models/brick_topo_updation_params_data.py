...
class BrickTopoUpdationParamsData(object):
    ...
    def __init__(self, tag_position_in_brick=None, node_topoes=None, capacity=None, height=None, name=None, position=None, local_vars_configuration=None):  # noqa: E501
