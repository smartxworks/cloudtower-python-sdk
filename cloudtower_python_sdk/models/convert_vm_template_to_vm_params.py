...
class ConvertVmTemplateToVmParams(object):
    ...
    def __init__(self, name=None, converted_from_template_id=None, local_vars_configuration=None):  # noqa: E501
        ...
        self.name = name
        self.converted_from_template_id = converted_from_template_id
