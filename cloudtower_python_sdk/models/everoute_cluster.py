...
class EverouteCluster(object):
    ...
    def __init__(self, agent_elf_clusters=None, agent_elf_vdses=None, controller_instances=None, controller_template=None, entity_async_status=None, global_default_action=None, global_whitelist=None, id=None, installed=None, name=None, phase=None, status=None, version=None, local_vars_configuration=None):  # noqa: E501
        ...
        self.agent_elf_clusters = agent_elf_clusters
        self.agent_elf_vdses = agent_elf_vdses
        self.controller_instances = controller_instances
