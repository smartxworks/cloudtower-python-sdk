...
class EverouteCluster(object):
    ...
    def __init__(self, agent_elf_clusters=None, agent_elf_vdses=None, controller_instances=None, controller_template=None, global_default_action=None, id=None, name=None, phase=None, status=None, version=None, local_vars_configuration=None):  # noqa: E501
