...
class AddLabelsToResourcesParamsData(object):
    ...
    def __init__(self, vms=None, vm_volumes=None, vm_templates=None, vm_snapshots=None, vlans=None, vdses=None, nvmf_subsystems=None, nvmf_namespace_snapshots=None, nvmf_namespaces=None, nics=None, nfs_inodes=None, nfs_exports=None, namespace_groups=None, iscsi_targets=None, iscsi_lun_snapshots=None, iscsi_luns=None, hosts=None, elf_images=None, disks=None, datacenters=None, consistency_group_snapshots=None, consistency_groups=None, clusters=None, local_vars_configuration=None):  # noqa: E501
