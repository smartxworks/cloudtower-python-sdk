...
class ClusterImage(object):
    ...
    def __init__(self, cluster=None, entity_async_status=None, id=None, meta_name=None, meta_size=None, name=None, size=None, version=None, local_vars_configuration=None):  # noqa: E501
