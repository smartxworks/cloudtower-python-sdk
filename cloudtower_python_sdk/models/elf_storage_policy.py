...
class ElfStoragePolicy(object):
    ...
    def __init__(self, cluster=None, description=None, entity_async_status=None, id=None, local_id=None, name=None, replica_num=None, stripe_num=None, stripe_size=None, thin_provision=None, local_vars_configuration=None):  # noqa: E501
