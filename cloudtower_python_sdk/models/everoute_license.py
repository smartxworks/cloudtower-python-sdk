...
class EverouteLicense(object):
    ...
    def __init__(self, cloud_tower=None, expire_date=None, id=None, license_serial=None, max_socket_num=None, sign_date=None, software_edition=None, type=None, local_vars_configuration=None):  # noqa: E501
    ...
    def cloud_tower(self):
        """Gets the cloud_tower of this EverouteLicense.  # noqa: E501


        :return: The cloud_tower of this EverouteLicense.  # noqa: E501
        :rtype: NestedDeploy
        """
    ...
    def cloud_tower(self, cloud_tower):
        """Sets the cloud_tower of this EverouteLicense.


        :param cloud_tower: The cloud_tower of this EverouteLicense.  # noqa: E501
        :type cloud_tower: NestedDeploy
        """
        if self.local_vars_configuration.client_side_validation and cloud_tower is None:  # noqa: E501
            raise ValueError("Invalid value for `cloud_tower`, must not be `None`")  # noqa: E501
    ...
    def license_serial(self):
        """Gets the license_serial of this EverouteLicense.  # noqa: E501


        :return: The license_serial of this EverouteLicense.  # noqa: E501
        :rtype: str
        """
    ...
    def license_serial(self, license_serial):
        """Sets the license_serial of this EverouteLicense.


        :param license_serial: The license_serial of this EverouteLicense.  # noqa: E501
