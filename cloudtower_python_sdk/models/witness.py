...
class Witness(object):
    ...
    def __init__(self, cluster=None, cpu_hz_per_core=None, data_ip=None, id=None, local_id=None, name=None, system_data_capacity=None, system_used_data_space=None, total_cpu_cores=None, total_cpu_hz=None, total_memory_bytes=None, local_vars_configuration=None):  # noqa: E501
