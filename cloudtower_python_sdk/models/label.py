...
class Label(object):
    ...
    def __init__(self, cluster_num=None, clusters=None, consistency_group_num=None, consistency_group_snapshot_num=None, consistency_group_snapshots=None, consistency_groups=None, content_library_image_num=None, content_library_images=None, content_library_vm_template_num=None, content_library_vm_templates=None, created_at=None, datacenter_num=None, datacenters=None, disk_num=None, disks=None, elf_image_num=None, elf_images=None, host_num=None, hosts=None, id=None, iscsi_lun_num=None, iscsi_lun_snapshot_num=None, iscsi_lun_snapshots=None, iscsi_luns=None, iscsi_target_num=None, iscsi_targets=None, isolation_policies=None, isolation_policy_num=None, key=None, namespace_group_num=None, namespace_groups=None, nfs_export_num=None, nfs_exports=None, nfs_inode_num=None, nfs_inodes=None, nic_num=None, nics=None, nvmf_namespace_num=None, nvmf_namespace_snapshot_num=None, nvmf_namespace_snapshots=None, nvmf_namespaces=None, nvmf_subsystem_num=None, nvmf_subsystems=None, security_policies=None, security_policy_num=None, system_vlan_num=None, total_num=None, value=None, vds_num=None, vdses=None, vlans=None, vm_num=None, vm_snapshot_num=None, vm_snapshots=None, vm_template_num=None, vm_templates=None, vm_vlan_num=None, vm_volume_num=None, vm_volumes=None, vms=None, local_vars_configuration=None):  # noqa: E501
        ...
        self.consistency_group_snapshots = consistency_group_snapshots
        self.consistency_groups = consistency_groups
        self.content_library_image_num = content_library_image_num
        self.content_library_images = content_library_images
        self.content_library_vm_template_num = content_library_vm_template_num
        self.content_library_vm_templates = content_library_vm_templates
        ...
        self.nvmf_namespace_snapshots = nvmf_namespace_snapshots
        self.nvmf_namespaces = nvmf_namespaces
        self.nvmf_subsystem_num = nvmf_subsystem_num
        self.nvmf_subsystems = nvmf_subsystems
