...
class License(object):
    ...
    def __init__(self, expire_date=None, id=None, license_serial=None, maintenance_end_date=None, maintenance_start_date=None, max_chunk_num=None, max_cluster_num=None, sign_date=None, software_edition=None, type=None, local_vars_configuration=None):  # noqa: E501
