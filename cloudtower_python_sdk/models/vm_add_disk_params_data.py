...
class VmAddDiskParamsData(object):
    ...
    def __init__(self, max_bandwidth_policy=None, max_bandwidth=None, max_iops_policy=None, max_iops=None, io_policy=None, vm_disks=None, local_vars_configuration=None):  # noqa: E501
