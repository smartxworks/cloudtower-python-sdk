...
class VmDiskParams(object):
    ...
    """
    openapi_types = {
        'mount_cd_roms': 'list[object]',
        'mount_disks': 'list[object]',
        'mount_new_create_disks': 'list[object]'
    }
    ...
    def __init__(self, mount_cd_roms=None, mount_disks=None, mount_new_create_disks=None, local_vars_configuration=None):  # noqa: E501
        ...
        if mount_cd_roms is not None:
            self.mount_cd_roms = mount_cd_roms
        if mount_disks is not None:
            self.mount_disks = mount_disks
        if mount_new_create_disks is not None:
            self.mount_new_create_disks = mount_new_create_disks
    ...
    def mount_cd_roms(self, mount_cd_roms):
        ...
        :type mount_cd_roms: list[object]
        """
    ...
    def mount_new_create_disks(self, mount_new_create_disks):
        ...
        :type mount_new_create_disks: list[object]
        """
