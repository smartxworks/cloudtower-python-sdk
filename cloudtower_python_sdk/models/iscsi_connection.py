...
class IscsiConnection(object):
    ...
    def __init__(self, client_port=None, cluster=None, host=None, id=None, initiator_ip=None, iscsi_target=None, nvmf_subsystem=None, type=None, local_vars_configuration=None):  # noqa: E501
