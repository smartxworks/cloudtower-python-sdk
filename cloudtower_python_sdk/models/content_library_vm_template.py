...
class ContentLibraryVmTemplate(object):
    ...
    def __init__(self, architecture=None, cloud_init_supported=None, clusters=None, created_at=None, description=None, entity_async_status=None, id=None, labels=None, memory=None, name=None, os=None, size=None, vcpu=None, vm_template_uuids=None, vm_templates=None, local_vars_configuration=None):  # noqa: E501
