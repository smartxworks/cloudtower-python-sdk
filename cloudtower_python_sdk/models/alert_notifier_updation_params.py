...
class AlertNotifierUpdationParams(object):
    ...
    def __init__(self, notice_severities=None, language_code=None, email_tos=None, email_from=None, disabled=None, local_vars_configuration=None):  # noqa: E501
        ...
        if notice_severities is not None:
