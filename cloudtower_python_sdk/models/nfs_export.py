...
class NfsExport(object):
    ...
    def __init__(self, cluster=None, description=None, entity_async_status=None, export_inode_id=None, id=None, inodes=None, internal=None, ip_whitelist=None, labels=None, local_id=None, name=None, replica_num=None, thin_provision=None, local_vars_configuration=None):  # noqa: E501
