...
class UserCreationParams(object):
    ...
    def __init__(self, mobile_phone=None, email_address=None, internal=None, role_id=None, name=None, password=None, username=None, local_vars_configuration=None):  # noqa: E501
