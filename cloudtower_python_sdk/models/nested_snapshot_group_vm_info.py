...
class NestedSnapshotGroupVmInfo(object):
    ...
    def __init__(self, disks=None, vm_id=None, vm_name=None, vm_snapshot_status=None, local_vars_configuration=None):  # noqa: E501
        ...
        self.vm_snapshot_status = vm_snapshot_status
