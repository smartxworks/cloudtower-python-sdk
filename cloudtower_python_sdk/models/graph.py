...
class Graph(object):
    ...
    def __init__(self, cluster=None, disks=None, entity_async_status=None, hosts=None, id=None, instance_ids=None, local_id=None, luns=None, metric_count=None, metric_name=None, metric_type=None, namespaces=None, network=None, nics=None, resource_type=None, service=None, targets=None, title=None, type=None, view=None, vm_nics=None, vms=None, vm_volumes=None, witnesses=None, zones=None, local_vars_configuration=None):  # noqa: E501
