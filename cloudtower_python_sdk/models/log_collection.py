...
class LogCollection(object):
    ...
    def __init__(self, cluster=None, groups=None, hosts=None, id=None, local_id=None, log_ended_at=None, log_started_at=None, owner=None, path=None, progress=None, services=None, size=None, started_at=None, status=None, witness=None, local_vars_configuration=None):  # noqa: E501
