...
class VmRebuildParams(object):
    ...
    def __init__(self, rebuild_from_snapshot_id=None, max_bandwidth_policy=None, max_bandwidth=None, max_iops_policy=None, max_iops=None, io_policy=None, vcpu=None, status=None, firmware=None, ha=None, vm_nics=None, vm_disks=None, memory=None, cpu_cores=None, cpu_sockets=None, guest_os_type=None, folder_id=None, description=None, name=None, host_id=None, cluster_id=None, local_vars_configuration=None):  # noqa: E501
        ...
        self.rebuild_from_snapshot_id = rebuild_from_snapshot_id
