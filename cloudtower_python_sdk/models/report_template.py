...
class ReportTemplate(object):
    ...
    def __init__(self, created_at=None, description=None, execute_plan=None, id=None, name=None, preset=None, resource_meta=None, task_num=None, tasks=None, local_vars_configuration=None):  # noqa: E501
