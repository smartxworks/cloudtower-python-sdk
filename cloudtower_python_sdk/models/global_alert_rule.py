...
class GlobalAlertRule(object):
    ...
    def __init__(self, alert_rules=None, boolean=None, cause=None, default_thresholds=None, disabled=None, id=None, impact=None, message=None, name=None, object=None, operator=None, solution=None, thresholds=None, unit=None, local_vars_configuration=None):  # noqa: E501
