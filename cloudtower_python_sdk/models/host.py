...
class Host(object):
    ...
    def __init__(self, access_ip=None, allocatable_memory_bytes=None, chunk_id=None, cluster=None, compatible_cpu_models=None, cpu_brand=None, cpu_fan_speed=None, cpu_fan_speed_unit=None, cpu_hz_per_core=None, cpu_model=None, cpu_temperature_celsius=None, data_ip=None, disks=None, failure_data_space=None, hdd_data_capacity=None, hdd_disk_count=None, id=None, ipmi=None, is_os_in_raid1=None, labels=None, local_id=None, lsm_cap_disk_safe_umount=None, management_ip=None, model=None, name=None, nested_virtualization=None, nic_count=None, nics=None, node_topo_local_id=None, os_memory_bytes=None, os_version=None, pmem_dimm_capacity=None, pmem_dimm_count=None, pmem_dimms=None, pmem_disk_count=None, provisioned_cpu_cores=None, provisioned_memory_bytes=None, running_pause_vm_memory_bytes=None, running_vm_num=None, scvm_cpu=None, scvm_memory=None, scvm_name=None, serial=None, ssd_data_capacity=None, ssd_disk_count=None, state=None, status=None, stopped_vm_num=None, suspended_vm_num=None, total_cache_capacity=None, total_cpu_cores=None, total_cpu_hz=None, total_cpu_sockets=None, total_data_capacity=None, total_memory_bytes=None, usb_devices=None, used_cpu_hz=None, used_data_space=None, used_memory_bytes=None, vm_num=None, vmotion_ip=None, vms=None, vsphere_esxi_account=None, with_faster_ssd_as_cache=None, zone=None, local_vars_configuration=None):  # noqa: E501
        ...
        self.compatible_cpu_models = compatible_cpu_models
        self.cpu_brand = cpu_brand
        self.cpu_fan_speed = cpu_fan_speed
        self.cpu_fan_speed_unit = cpu_fan_speed_unit
        self.cpu_hz_per_core = cpu_hz_per_core
        self.cpu_model = cpu_model
        self.cpu_temperature_celsius = cpu_temperature_celsius
