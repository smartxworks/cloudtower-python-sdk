...
class NvmfSubsystemCreationParamsAllOf(object):
    ...
    def __init__(self, replica_num=None, thin_provision=None, stripe_size=None, stripe_num=None, policy=None, cluster_id=None, name=None, local_vars_configuration=None):  # noqa: E501
