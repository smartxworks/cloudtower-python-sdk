...
class VmPlacementGroupUpdationParamsData(object):
    ...
    def __init__(self, vm_vm_policy=None, vms=None, prefer_hosts=None, must_hosts=None, vm_host_prefer_enabled=None, vm_host_must_policy=None, vm_host_must_enabled=None, vm_host_prefer_policy=None, vm_vm_policy_enabled=None, name=None, description=None, enabled=None, local_vars_configuration=None):  # noqa: E501
