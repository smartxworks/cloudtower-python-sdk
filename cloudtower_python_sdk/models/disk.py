...
class Disk(object):
    ...
    def __init__(self, entity_async_status=None, failure_information=None, firmware=None, function=None, health_status=None, healthy=None, host=None, id=None, labels=None, local_id=None, model=None, mounted=None, name=None, numa_node=None, offline=None, partitions=None, path=None, persistent_memory_type=None, physical_slot_on_brick=None, pmem_dimms=None, recommended_usage=None, remaining_life_percent=None, serial=None, size=None, type=None, usage=None, usage_status=None, local_vars_configuration=None):  # noqa: E501
        ...
        self.failure_information = failure_information
