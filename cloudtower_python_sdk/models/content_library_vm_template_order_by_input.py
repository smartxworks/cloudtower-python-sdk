...
class ContentLibraryVmTemplateOrderByInput(object):
    ...
    allowable_values = [CLOUD_INIT_SUPPORTED_ASC, CLOUD_INIT_SUPPORTED_DESC, CPU_ASC, CPU_DESC, CREATEDAT_ASC, CREATEDAT_DESC, DESCRIPTION_ASC, DESCRIPTION_DESC, ENTITYASYNCSTATUS_ASC, ENTITYASYNCSTATUS_DESC, GUEST_OS_TYPE_ASC, GUEST_OS_TYPE_DESC, ID_ASC, ID_DESC, MEMORY_ASC, MEMORY_DESC, NAME_ASC, NAME_DESC, SIZE_ASC, SIZE_DESC, UPDATEDAT_ASC, UPDATEDAT_DESC, VCPU_ASC, VCPU_DESC]  # noqa: E501
