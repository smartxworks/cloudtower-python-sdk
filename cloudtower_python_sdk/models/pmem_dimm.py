...
class PmemDimm(object):
    ...
    def __init__(self, capacity=None, device_locator=None, disk=None, health_status=None, host=None, id=None, local_id=None, name=None, numa_node=None, part_number=None, remaining_life_percent=None, version=None, local_vars_configuration=None):  # noqa: E501
