...
class ZoneTopoWhereInput(object):
    ...
    def __init__(self, _and=None, cluster=None, cluster_topo=None, id=None, id_contains=None, id_ends_with=None, id_gt=None, id_gte=None, id_in=None, id_lt=None, id_lte=None, id_not=None, id_not_contains=None, id_not_ends_with=None, id_not_in=None, id_not_starts_with=None, id_starts_with=None, local_id=None, local_id_contains=None, local_id_ends_with=None, local_id_gt=None, local_id_gte=None, local_id_in=None, local_id_lt=None, local_id_lte=None, local_id_not=None, local_id_not_contains=None, local_id_not_ends_with=None, local_id_not_in=None, local_id_not_starts_with=None, local_id_starts_with=None, _not=None, _or=None, rack_topoes_every=None, rack_topoes_none=None, rack_topoes_some=None, local_vars_configuration=None):  # noqa: E501
        ...
        self._not = _not
        self._or = _or
        self.rack_topoes_every = rack_topoes_every
        self.rack_topoes_none = rack_topoes_none
        self.rack_topoes_some = rack_topoes_some
