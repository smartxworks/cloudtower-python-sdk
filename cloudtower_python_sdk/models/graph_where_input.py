...
class GraphWhereInput(object):
    ...
    def __init__(self, _and=None, cluster=None, disks_every=None, disks_none=None, disks_some=None, entity_async_status=None, entity_async_status_in=None, entity_async_status_not=None, entity_async_status_not_in=None, hosts_every=None, hosts_none=None, hosts_some=None, id=None, id_contains=None, id_ends_with=None, id_gt=None, id_gte=None, id_in=None, id_lt=None, id_lte=None, id_not=None, id_not_contains=None, id_not_ends_with=None, id_not_in=None, id_not_starts_with=None, id_starts_with=None, local_id=None, local_id_contains=None, local_id_ends_with=None, local_id_gt=None, local_id_gte=None, local_id_in=None, local_id_lt=None, local_id_lte=None, local_id_not=None, local_id_not_contains=None, local_id_not_ends_with=None, local_id_not_in=None, local_id_not_starts_with=None, local_id_starts_with=None, luns_every=None, luns_none=None, luns_some=None, metric_count=None, metric_count_gt=None, metric_count_gte=None, metric_count_in=None, metric_count_lt=None, metric_count_lte=None, metric_count_not=None, metric_count_not_in=None, metric_name=None, metric_name_contains=None, metric_name_ends_with=None, metric_name_gt=None, metric_name_gte=None, metric_name_in=None, metric_name_lt=None, metric_name_lte=None, metric_name_not=None, metric_name_not_contains=None, metric_name_not_ends_with=None, metric_name_not_in=None, metric_name_not_starts_with=None, metric_name_starts_with=None, metric_type=None, metric_type_in=None, metric_type_not=None, metric_type_not_in=None, namespaces_every=None, namespaces_none=None, namespaces_some=None, network=None, network_in=None, network_not=None, network_not_in=None, nics_every=None, nics_none=None, nics_some=None, _not=None, _or=None, resource_type=None, resource_type_contains=None, resource_type_ends_with=None, resource_type_gt=None, resource_type_gte=None, resource_type_in=None, resource_type_lt=None, resource_type_lte=None, resource_type_not=None, resource_type_not_contains=None, resource_type_not_ends_with=None, resource_type_not_in=None, resource_type_not_starts_with=None, resource_type_starts_with=None, service=None, service_contains=None, service_ends_with=None, service_gt=None, service_gte=None, service_in=None, service_lt=None, service_lte=None, service_not=None, service_not_contains=None, service_not_ends_with=None, service_not_in=None, service_not_starts_with=None, service_starts_with=None, title=None, title_contains=None, title_ends_with=None, title_gt=None, title_gte=None, title_in=None, title_lt=None, title_lte=None, title_not=None, title_not_contains=None, title_not_ends_with=None, title_not_in=None, title_not_starts_with=None, title_starts_with=None, type=None, type_in=None, type_not=None, type_not_in=None, view=None, vm_nics_every=None, vm_nics_none=None, vm_nics_some=None, vms_every=None, vms_none=None, vms_some=None, vm_volumes_every=None, vm_volumes_none=None, vm_volumes_some=None, witnesses_every=None, witnesses_none=None, witnesses_some=None, zones_every=None, zones_none=None, zones_some=None, local_vars_configuration=None):  # noqa: E501
        ...
        self.metric_count_gt = metric_count_gt
        self.metric_count_gte = metric_count_gte
        self.metric_count_in = metric_count_in
        self.metric_count_lt = metric_count_lt
        self.metric_count_lte = metric_count_lte
        self.metric_count_not = metric_count_not
        self.metric_count_not_in = metric_count_not_in
        self.metric_name = metric_name
        self.metric_name_contains = metric_name_contains
        self.metric_name_ends_with = metric_name_ends_with
        self.metric_name_gt = metric_name_gt
        self.metric_name_gte = metric_name_gte
        self.metric_name_in = metric_name_in
        self.metric_name_lt = metric_name_lt
        self.metric_name_lte = metric_name_lte
        self.metric_name_not = metric_name_not
        self.metric_name_not_contains = metric_name_not_contains
        self.metric_name_not_ends_with = metric_name_not_ends_with
        self.metric_name_not_in = metric_name_not_in
        self.metric_name_not_starts_with = metric_name_not_starts_with
        self.metric_name_starts_with = metric_name_starts_with
        self.metric_type = metric_type
        self.metric_type_in = metric_type_in
        self.metric_type_not = metric_type_not
        self.metric_type_not_in = metric_type_not_in
        ...
        self.network_not = network_not
        self.network_not_in = network_not_in
        ...
        self.service_contains = service_contains
        self.service_ends_with = service_ends_with
        self.service_gt = service_gt
        self.service_gte = service_gte
        self.service_in = service_in
        self.service_lt = service_lt
        self.service_lte = service_lte
        self.service_not = service_not
        self.service_not_contains = service_not_contains
        self.service_not_ends_with = service_not_ends_with
        self.service_not_in = service_not_in
        self.service_not_starts_with = service_not_starts_with
        self.service_starts_with = service_starts_with
        self.title = title
        self.title_contains = title_contains
        self.title_ends_with = title_ends_with
        self.title_gt = title_gt
        self.title_gte = title_gte
        self.title_in = title_in
        self.title_lt = title_lt
        self.title_lte = title_lte
        self.title_not = title_not
        self.title_not_contains = title_not_contains
        self.title_not_ends_with = title_not_ends_with
        self.title_not_in = title_not_in
        self.title_not_starts_with = title_not_starts_with
        self.title_starts_with = title_starts_with
        self.type = type
        ...
        self.witnesses_every = witnesses_every
        self.witnesses_none = witnesses_none
        self.witnesses_some = witnesses_some
