...
class EverouteClusterOrderByInput(object):
    ...
    allowable_values = [CONTROLLER_INSTANCES_ASC, CONTROLLER_INSTANCES_DESC, CONTROLLER_TEMPLATE_ASC, CONTROLLER_TEMPLATE_DESC, CREATEDAT_ASC, CREATEDAT_DESC, GLOBAL_DEFAULT_ACTION_ASC, GLOBAL_DEFAULT_ACTION_DESC, ID_ASC, ID_DESC, NAME_ASC, NAME_DESC, PHASE_ASC, PHASE_DESC, STATUS_ASC, STATUS_DESC, UPDATEDAT_ASC, UPDATEDAT_DESC, VERSION_ASC, VERSION_DESC]  # noqa: E501
