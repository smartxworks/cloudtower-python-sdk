...
class ViewWhereInput(object):
    ...
    def __init__(self, _and=None, cluster=None, entity_async_status=None, entity_async_status_in=None, entity_async_status_not=None, entity_async_status_not_in=None, graphs_every=None, graphs_none=None, graphs_some=None, id=None, id_contains=None, id_ends_with=None, id_gt=None, id_gte=None, id_in=None, id_lt=None, id_lte=None, id_not=None, id_not_contains=None, id_not_ends_with=None, id_not_in=None, id_not_starts_with=None, id_starts_with=None, local_id=None, local_id_contains=None, local_id_ends_with=None, local_id_gt=None, local_id_gte=None, local_id_in=None, local_id_lt=None, local_id_lte=None, local_id_not=None, local_id_not_contains=None, local_id_not_ends_with=None, local_id_not_in=None, local_id_not_starts_with=None, local_id_starts_with=None, name=None, name_contains=None, name_ends_with=None, name_gt=None, name_gte=None, name_in=None, name_lt=None, name_lte=None, name_not=None, name_not_contains=None, name_not_ends_with=None, name_not_in=None, name_not_starts_with=None, name_starts_with=None, _not=None, _or=None, time_span=None, time_span_gt=None, time_span_gte=None, time_span_in=None, time_span_lt=None, time_span_lte=None, time_span_not=None, time_span_not_in=None, time_unit=None, time_unit_in=None, time_unit_not=None, time_unit_not_in=None, local_vars_configuration=None):  # noqa: E501
        ...
        self.graphs_every = graphs_every
        self.graphs_none = graphs_none
        self.graphs_some = graphs_some
        self.id = id
        ...
        self.time_span_gt = time_span_gt
        self.time_span_gte = time_span_gte
        self.time_span_in = time_span_in
        self.time_span_lt = time_span_lt
        self.time_span_lte = time_span_lte
        self.time_span_not = time_span_not
        self.time_span_not_in = time_span_not_in
        self.time_unit = time_unit
        self.time_unit_in = time_unit_in
        self.time_unit_not = time_unit_not
        self.time_unit_not_in = time_unit_not_in
