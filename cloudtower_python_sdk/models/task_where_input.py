...
class TaskWhereInput(object):
    ...
    def __init__(self, _and=None, cluster=None, description=None, description_contains=None, description_ends_with=None, description_gt=None, description_gte=None, description_in=None, description_lt=None, description_lte=None, description_not=None, description_not_contains=None, description_not_ends_with=None, description_not_in=None, description_not_starts_with=None, description_starts_with=None, error_code=None, error_code_contains=None, error_code_ends_with=None, error_code_gt=None, error_code_gte=None, error_code_in=None, error_code_lt=None, error_code_lte=None, error_code_not=None, error_code_not_contains=None, error_code_not_ends_with=None, error_code_not_in=None, error_code_not_starts_with=None, error_code_starts_with=None, error_message=None, error_message_contains=None, error_message_ends_with=None, error_message_gt=None, error_message_gte=None, error_message_in=None, error_message_lt=None, error_message_lte=None, error_message_not=None, error_message_not_contains=None, error_message_not_ends_with=None, error_message_not_in=None, error_message_not_starts_with=None, error_message_starts_with=None, finished_at=None, finished_at_gt=None, finished_at_gte=None, finished_at_in=None, finished_at_lt=None, finished_at_lte=None, finished_at_not=None, finished_at_not_in=None, id=None, id_contains=None, id_ends_with=None, id_gt=None, id_gte=None, id_in=None, id_lt=None, id_lte=None, id_not=None, id_not_contains=None, id_not_ends_with=None, id_not_in=None, id_not_starts_with=None, id_starts_with=None, internal=None, internal_not=None, local_created_at=None, local_created_at_gt=None, local_created_at_gte=None, local_created_at_in=None, local_created_at_lt=None, local_created_at_lte=None, local_created_at_not=None, local_created_at_not_in=None, _not=None, _or=None, progress=None, progress_gt=None, progress_gte=None, progress_in=None, progress_lt=None, progress_lte=None, progress_not=None, progress_not_in=None, resource_id=None, resource_id_contains=None, resource_id_ends_with=None, resource_id_gt=None, resource_id_gte=None, resource_id_in=None, resource_id_lt=None, resource_id_lte=None, resource_id_not=None, resource_id_not_contains=None, resource_id_not_ends_with=None, resource_id_not_in=None, resource_id_not_starts_with=None, resource_id_starts_with=None, resource_mutation=None, resource_mutation_contains=None, resource_mutation_ends_with=None, resource_mutation_gt=None, resource_mutation_gte=None, resource_mutation_in=None, resource_mutation_lt=None, resource_mutation_lte=None, resource_mutation_not=None, resource_mutation_not_contains=None, resource_mutation_not_ends_with=None, resource_mutation_not_in=None, resource_mutation_not_starts_with=None, resource_mutation_starts_with=None, resource_rollback_error=None, resource_rollback_error_contains=None, resource_rollback_error_ends_with=None, resource_rollback_error_gt=None, resource_rollback_error_gte=None, resource_rollback_error_in=None, resource_rollback_error_lt=None, resource_rollback_error_lte=None, resource_rollback_error_not=None, resource_rollback_error_not_contains=None, resource_rollback_error_not_ends_with=None, resource_rollback_error_not_in=None, resource_rollback_error_not_starts_with=None, resource_rollback_error_starts_with=None, resource_rollback_retry_count=None, resource_rollback_retry_count_gt=None, resource_rollback_retry_count_gte=None, resource_rollback_retry_count_in=None, resource_rollback_retry_count_lt=None, resource_rollback_retry_count_lte=None, resource_rollback_retry_count_not=None, resource_rollback_retry_count_not_in=None, resource_rollbacked=None, resource_rollbacked_not=None, resource_type=None, resource_type_contains=None, resource_type_ends_with=None, resource_type_gt=None, resource_type_gte=None, resource_type_in=None, resource_type_lt=None, resource_type_lte=None, resource_type_not=None, resource_type_not_contains=None, resource_type_not_ends_with=None, resource_type_not_in=None, resource_type_not_starts_with=None, resource_type_starts_with=None, snapshot=None, snapshot_contains=None, snapshot_ends_with=None, snapshot_gt=None, snapshot_gte=None, snapshot_in=None, snapshot_lt=None, snapshot_lte=None, snapshot_not=None, snapshot_not_contains=None, snapshot_not_ends_with=None, snapshot_not_in=None, snapshot_not_starts_with=None, snapshot_starts_with=None, started_at=None, started_at_gt=None, started_at_gte=None, started_at_in=None, started_at_lt=None, started_at_lte=None, started_at_not=None, started_at_not_in=None, status=None, status_in=None, status_not=None, status_not_in=None, user=None, local_vars_configuration=None):  # noqa: E501
        ...
        self.error_code_contains = error_code_contains
        self.error_code_ends_with = error_code_ends_with
        self.error_code_gt = error_code_gt
        self.error_code_gte = error_code_gte
        self.error_code_in = error_code_in
        self.error_code_lt = error_code_lt
        self.error_code_lte = error_code_lte
        self.error_code_not = error_code_not
        self.error_code_not_contains = error_code_not_contains
        self.error_code_not_ends_with = error_code_not_ends_with
        self.error_code_not_in = error_code_not_in
        self.error_code_not_starts_with = error_code_not_starts_with
        self.error_code_starts_with = error_code_starts_with
        ...
        self.finished_at_gt = finished_at_gt
        self.finished_at_gte = finished_at_gte
        self.finished_at_in = finished_at_in
        self.finished_at_lt = finished_at_lt
        self.finished_at_lte = finished_at_lte
        self.finished_at_not = finished_at_not
        self.finished_at_not_in = finished_at_not_in
        self.id = id
        ...
        self.progress_gte = progress_gte
        self.progress_in = progress_in
        self.progress_lt = progress_lt
        self.progress_lte = progress_lte
        self.progress_not = progress_not
        self.progress_not_in = progress_not_in
        self.resource_id = resource_id
        self.resource_id_contains = resource_id_contains
        self.resource_id_ends_with = resource_id_ends_with
        self.resource_id_gt = resource_id_gt
        self.resource_id_gte = resource_id_gte
        self.resource_id_in = resource_id_in
        self.resource_id_lt = resource_id_lt
        self.resource_id_lte = resource_id_lte
        self.resource_id_not = resource_id_not
        self.resource_id_not_contains = resource_id_not_contains
        self.resource_id_not_ends_with = resource_id_not_ends_with
        self.resource_id_not_in = resource_id_not_in
        self.resource_id_not_starts_with = resource_id_not_starts_with
        self.resource_id_starts_with = resource_id_starts_with
        self.resource_mutation = resource_mutation
        self.resource_mutation_contains = resource_mutation_contains
        self.resource_mutation_ends_with = resource_mutation_ends_with
        self.resource_mutation_gt = resource_mutation_gt
        self.resource_mutation_gte = resource_mutation_gte
        self.resource_mutation_in = resource_mutation_in
        self.resource_mutation_lt = resource_mutation_lt
        self.resource_mutation_lte = resource_mutation_lte
        self.resource_mutation_not = resource_mutation_not
        self.resource_mutation_not_contains = resource_mutation_not_contains
        self.resource_mutation_not_ends_with = resource_mutation_not_ends_with
        self.resource_mutation_not_in = resource_mutation_not_in
        self.resource_mutation_not_starts_with = resource_mutation_not_starts_with
        self.resource_mutation_starts_with = resource_mutation_starts_with
        self.resource_rollback_error = resource_rollback_error
        self.resource_rollback_error_contains = resource_rollback_error_contains
        self.resource_rollback_error_ends_with = resource_rollback_error_ends_with
        self.resource_rollback_error_gt = resource_rollback_error_gt
        self.resource_rollback_error_gte = resource_rollback_error_gte
        self.resource_rollback_error_in = resource_rollback_error_in
        self.resource_rollback_error_lt = resource_rollback_error_lt
        self.resource_rollback_error_lte = resource_rollback_error_lte
        self.resource_rollback_error_not = resource_rollback_error_not
        self.resource_rollback_error_not_contains = resource_rollback_error_not_contains
        self.resource_rollback_error_not_ends_with = resource_rollback_error_not_ends_with
        self.resource_rollback_error_not_in = resource_rollback_error_not_in
        self.resource_rollback_error_not_starts_with = resource_rollback_error_not_starts_with
        self.resource_rollback_error_starts_with = resource_rollback_error_starts_with
        self.resource_rollback_retry_count = resource_rollback_retry_count
        self.resource_rollback_retry_count_gt = resource_rollback_retry_count_gt
        self.resource_rollback_retry_count_gte = resource_rollback_retry_count_gte
        self.resource_rollback_retry_count_in = resource_rollback_retry_count_in
        self.resource_rollback_retry_count_lt = resource_rollback_retry_count_lt
        self.resource_rollback_retry_count_lte = resource_rollback_retry_count_lte
        self.resource_rollback_retry_count_not = resource_rollback_retry_count_not
        self.resource_rollback_retry_count_not_in = resource_rollback_retry_count_not_in
        self.resource_rollbacked = resource_rollbacked
        self.resource_rollbacked_not = resource_rollbacked_not
        self.resource_type = resource_type
        self.resource_type_contains = resource_type_contains
        self.resource_type_ends_with = resource_type_ends_with
        self.resource_type_gt = resource_type_gt
        self.resource_type_gte = resource_type_gte
        self.resource_type_in = resource_type_in
        self.resource_type_lt = resource_type_lt
        self.resource_type_lte = resource_type_lte
        self.resource_type_not = resource_type_not
        self.resource_type_not_contains = resource_type_not_contains
        self.resource_type_not_ends_with = resource_type_not_ends_with
        self.resource_type_not_in = resource_type_not_in
        self.resource_type_not_starts_with = resource_type_not_starts_with
        self.resource_type_starts_with = resource_type_starts_with
        self.snapshot = snapshot
        self.snapshot_contains = snapshot_contains
        self.snapshot_ends_with = snapshot_ends_with
        self.snapshot_gt = snapshot_gt
        self.snapshot_gte = snapshot_gte
        self.snapshot_in = snapshot_in
        self.snapshot_lt = snapshot_lt
        self.snapshot_lte = snapshot_lte
        self.snapshot_not = snapshot_not
        self.snapshot_not_contains = snapshot_not_contains
        self.snapshot_not_ends_with = snapshot_not_ends_with
        self.snapshot_not_in = snapshot_not_in
        self.snapshot_not_starts_with = snapshot_not_starts_with
        self.snapshot_starts_with = snapshot_starts_with
        self.started_at = started_at
        self.started_at_gt = started_at_gt
        self.started_at_gte = started_at_gte
        self.started_at_in = started_at_in
        self.started_at_lt = started_at_lt
        self.started_at_lte = started_at_lte
        self.started_at_not = started_at_not
        self.started_at_not_in = started_at_not_in
        self.status = status
