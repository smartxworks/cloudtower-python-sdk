...
class NestedDiscoveredHostIface(object):
    ...
    def __init__(self, ipv4=None, ipv6=None, mac_address=None, mtu=None, name=None, pci_slot_name=None, rdma_enabled=None, speed=None, up=None, local_vars_configuration=None):  # noqa: E501
        ...
        self.mtu = mtu
        self.name = name
        self.pci_slot_name = pci_slot_name
