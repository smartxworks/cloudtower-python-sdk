...
class SnapshotPlan(object):
    ...
    def __init__(self, auto_delete_num=None, auto_execute_num=None, cluster=None, description=None, end_time=None, entity_async_status=None, exec_h_m=None, execute_intervals=None, execute_plan_type=None, execution_tasks=None, healthy=None, id=None, last_execute_end_time=None, last_execute_status=None, last_execute_time=None, local_id=None, logical_size_bytes=None, manual_delete_num=None, manual_execute_num=None, mirror=None, name=None, next_execute_time=None, object_num=None, physical_size_bytes=None, remain_snapshot_num=None, snapshot_group_num=None, start_time=None, status=None, vms=None, local_vars_configuration=None):  # noqa: E501
