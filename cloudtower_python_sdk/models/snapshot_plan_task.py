...
class SnapshotPlanTask(object):
    ...
    def __init__(self, cluster=None, end_time=None, entity_async_status=None, id=None, internal=None, local_id=None, snapshot_group=None, snapshot_plan=None, start_time=None, status=None, type=None, local_vars_configuration=None):  # noqa: E501
