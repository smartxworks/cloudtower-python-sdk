...
class IscsiLunSnapshot(object):
    ...
    def __init__(self, consistency_group_snapshot=None, entity_async_status=None, id=None, iscsi_lun=None, iscsi_target=None, labels=None, local_created_at=None, local_id=None, name=None, unique_size=None, local_vars_configuration=None):  # noqa: E501
