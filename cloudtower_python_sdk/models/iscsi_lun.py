...
class IscsiLun(object):
    ...
    def __init__(self, allowed_initiators=None, assigned_size=None, bps=None, bps_max=None, bps_max_length=None, bps_rd=None, bps_rd_max=None, bps_rd_max_length=None, bps_wr=None, bps_wr_max=None, bps_wr_max_length=None, consistency_group=None, entity_async_status=None, id=None, io_size=None, iops=None, iops_max=None, iops_max_length=None, iops_rd=None, iops_rd_max=None, iops_rd_max_length=None, iops_wr=None, iops_wr_max=None, iops_wr_max_length=None, iscsi_target=None, labels=None, local_created_at=None, local_id=None, lun_id=None, name=None, replica_num=None, shared_size=None, snapshot_num=None, stripe_num=None, stripe_size=None, thin_provision=None, unique_size=None, zbs_volume_id=None, local_vars_configuration=None):  # noqa: E501
