...
class VmUpdateNicParamsData(object):
    ...
    def __init__(self, subnet_mask=None, gateway=None, ip_address=None, nic_id=None, connect_vlan_id=None, mirror=None, model=None, enabled=None, mac_address=None, nic_index=None, local_vars_configuration=None):  # noqa: E501
        ...
        if nic_id is not None:
            self.nic_id = nic_id
        if connect_vlan_id is not None:
            self.connect_vlan_id = connect_vlan_id
