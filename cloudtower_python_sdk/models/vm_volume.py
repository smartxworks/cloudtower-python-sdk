...
class VmVolume(object):
    ...
    def __init__(self, cluster=None, description=None, elf_storage_policy=None, guest_size_usage=None, guest_used_size=None, id=None, labels=None, local_created_at=None, local_id=None, lun=None, mounting=None, name=None, path=None, sharing=None, size=None, unique_size=None, vm_disks=None, local_vars_configuration=None):  # noqa: E501
