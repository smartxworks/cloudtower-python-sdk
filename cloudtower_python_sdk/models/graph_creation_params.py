...
class GraphCreationParams(object):
    ...
    def __init__(self, instance_ids=None, network=None, service=None, metric_type=None, metric_count=None, type=None, resource_type=None, view_id=None, title=None, cluster_id=None, connect_id=None, metric_name=None, local_vars_configuration=None):  # noqa: E501
