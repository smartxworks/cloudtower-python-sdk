...
class ClusterImageOrderByInput(object):
    ...
    allowable_values = [CREATEDAT_ASC, CREATEDAT_DESC, ENTITYASYNCSTATUS_ASC, ENTITYASYNCSTATUS_DESC, ID_ASC, ID_DESC, META_NAME_ASC, META_NAME_DESC, META_SIZE_ASC, META_SIZE_DESC, NAME_ASC, NAME_DESC, SIZE_ASC, SIZE_DESC, UPDATEDAT_ASC, UPDATEDAT_DESC, VERSION_ASC, VERSION_DESC]  # noqa: E501
