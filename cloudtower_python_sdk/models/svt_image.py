...
class SvtImage(object):
    ...
    def __init__(self, cluster=None, entity_async_status=None, id=None, local_created_at=None, local_id=None, name=None, path=None, size=None, version=None, vm_disks=None, local_vars_configuration=None):  # noqa: E501
