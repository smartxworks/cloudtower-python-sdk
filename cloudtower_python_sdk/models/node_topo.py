...
class NodeTopo(object):
    ...
    def __init__(self, brick_topo=None, cluster=None, cluster_topo=None, host=None, id=None, local_id=None, name=None, position=None, local_vars_configuration=None):  # noqa: E501
