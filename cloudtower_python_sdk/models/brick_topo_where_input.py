...
class BrickTopoWhereInput(object):
    ...
    def __init__(self, _and=None, cluster=None, cluster_topo=None, height=None, height_gt=None, height_gte=None, height_in=None, height_lt=None, height_lte=None, height_not=None, height_not_in=None, id=None, id_contains=None, id_ends_with=None, id_gt=None, id_gte=None, id_in=None, id_lt=None, id_lte=None, id_not=None, id_not_contains=None, id_not_ends_with=None, id_not_in=None, id_not_starts_with=None, id_starts_with=None, local_id=None, local_id_contains=None, local_id_ends_with=None, local_id_gt=None, local_id_gte=None, local_id_in=None, local_id_lt=None, local_id_lte=None, local_id_not=None, local_id_not_contains=None, local_id_not_ends_with=None, local_id_not_in=None, local_id_not_starts_with=None, local_id_starts_with=None, model=None, model_contains=None, model_ends_with=None, model_gt=None, model_gte=None, model_in=None, model_lt=None, model_lte=None, model_not=None, model_not_contains=None, model_not_ends_with=None, model_not_in=None, model_not_starts_with=None, model_starts_with=None, name=None, name_contains=None, name_ends_with=None, name_gt=None, name_gte=None, name_in=None, name_lt=None, name_lte=None, name_not=None, name_not_contains=None, name_not_ends_with=None, name_not_in=None, name_not_starts_with=None, name_starts_with=None, node_topoes_every=None, node_topoes_none=None, node_topoes_some=None, _not=None, _or=None, position=None, position_gt=None, position_gte=None, position_in=None, position_lt=None, position_lte=None, position_not=None, position_not_in=None, power_layout=None, power_layout_in=None, power_layout_not=None, power_layout_not_in=None, power_position=None, power_position_in=None, power_position_not=None, power_position_not_in=None, rack_topo=None, local_vars_configuration=None):  # noqa: E501
        ...
        self.height_gte = height_gte
        self.height_in = height_in
        self.height_lt = height_lt
        self.height_lte = height_lte
        self.height_not = height_not
        self.height_not_in = height_not_in
        self.id = id
        ...
        self.position_gte = position_gte
        self.position_in = position_in
        self.position_lt = position_lt
        self.position_lte = position_lte
        self.position_not = position_not
        self.position_not_in = position_not_in
        self.power_layout = power_layout
        self.power_layout_in = power_layout_in
        self.power_layout_not = power_layout_not
        self.power_layout_not_in = power_layout_not_in
        self.power_position = power_position
        self.power_position_in = power_position_in
        self.power_position_not = power_position_not
        self.power_position_not_in = power_position_not_in
