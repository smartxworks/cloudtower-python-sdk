...
class ClusterTopo(object):
    ...
    def __init__(self, brick_topoes=None, cluster=None, id=None, local_id=None, name=None, node_topoes=None, zone_topoes=None, local_vars_configuration=None):  # noqa: E501
