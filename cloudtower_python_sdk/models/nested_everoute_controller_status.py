...
class NestedEverouteControllerStatus(object):
    ...
    def __init__(self, ip_addr=None, is_health=None, message=None, metrics=None, phase=None, reason=None, vm=None, vm_id=None, local_vars_configuration=None):  # noqa: E501
