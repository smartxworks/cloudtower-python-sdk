...
class UploadTaskWhereInput(object):
    ...
    openapi_types = {
        ...
        'chunk_size': 'float',
        'chunk_size_gt': 'float',
        'chunk_size_gte': 'float',
        'chunk_size_in': 'list[float]',
        'chunk_size_lt': 'float',
        'chunk_size_lte': 'float',
        'chunk_size_not': 'float',
        'chunk_size_not_in': 'list[float]',
        'current_chunk': 'int',
    ...
    def __init__(self, _and=None, chunk_size=None, chunk_size_gt=None, chunk_size_gte=None, chunk_size_in=None, chunk_size_lt=None, chunk_size_lte=None, chunk_size_not=None, chunk_size_not_in=None, current_chunk=None, current_chunk_gt=None, current_chunk_gte=None, current_chunk_in=None, current_chunk_lt=None, current_chunk_lte=None, current_chunk_not=None, current_chunk_not_in=None, finished_at=None, finished_at_gt=None, finished_at_gte=None, finished_at_in=None, finished_at_lt=None, finished_at_lte=None, finished_at_not=None, finished_at_not_in=None, id=None, id_contains=None, id_ends_with=None, id_gt=None, id_gte=None, id_in=None, id_lt=None, id_lte=None, id_not=None, id_not_contains=None, id_not_ends_with=None, id_not_in=None, id_not_starts_with=None, id_starts_with=None, _not=None, _or=None, resource_type=None, resource_type_in=None, resource_type_not=None, resource_type_not_in=None, size=None, size_gt=None, size_gte=None, size_in=None, size_lt=None, size_lte=None, size_not=None, size_not_in=None, started_at=None, started_at_gt=None, started_at_gte=None, started_at_in=None, started_at_lt=None, started_at_lte=None, started_at_not=None, started_at_not_in=None, status=None, status_in=None, status_not=None, status_not_in=None, updated_at=None, updated_at_gt=None, updated_at_gte=None, updated_at_in=None, updated_at_lt=None, updated_at_lte=None, updated_at_not=None, updated_at_not_in=None, local_vars_configuration=None):  # noqa: E501
        ...
        self.chunk_size_gt = chunk_size_gt
        self.chunk_size_gte = chunk_size_gte
        self.chunk_size_in = chunk_size_in
        self.chunk_size_lt = chunk_size_lt
        self.chunk_size_lte = chunk_size_lte
        self.chunk_size_not = chunk_size_not
        self.chunk_size_not_in = chunk_size_not_in
        self.current_chunk = current_chunk
        self.current_chunk_gt = current_chunk_gt
        self.current_chunk_gte = current_chunk_gte
        self.current_chunk_in = current_chunk_in
        self.current_chunk_lt = current_chunk_lt
        self.current_chunk_lte = current_chunk_lte
        self.current_chunk_not = current_chunk_not
        self.current_chunk_not_in = current_chunk_not_in
        ...
        self.updated_at_gt = updated_at_gt
        self.updated_at_gte = updated_at_gte
        self.updated_at_in = updated_at_in
        self.updated_at_lt = updated_at_lt
        self.updated_at_lte = updated_at_lte
        self.updated_at_not = updated_at_not
        self.updated_at_not_in = updated_at_not_in
    ...
    def chunk_size_not_in(self, chunk_size_not_in):
        ...
        :type chunk_size_not_in: list[float]
        """
