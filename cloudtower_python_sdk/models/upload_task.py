...
class UploadTask(object):
    ...
    def __init__(self, args=None, chunk_size=None, current_chunk=None, finished_at=None, id=None, resource_type=None, size=None, started_at=None, status=None, updated_at=None, local_vars_configuration=None):  # noqa: E501
