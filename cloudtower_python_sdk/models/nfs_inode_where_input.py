...
class NfsInodeWhereInput(object):
    ...
    def __init__(self, _and=None, assigned_size=None, assigned_size_gt=None, assigned_size_gte=None, assigned_size_in=None, assigned_size_lt=None, assigned_size_lte=None, assigned_size_not=None, assigned_size_not_in=None, entity_async_status=None, entity_async_status_in=None, entity_async_status_not=None, entity_async_status_not_in=None, file=None, file_not=None, id=None, id_contains=None, id_ends_with=None, id_gt=None, id_gte=None, id_in=None, id_lt=None, id_lte=None, id_not=None, id_not_contains=None, id_not_ends_with=None, id_not_in=None, id_not_starts_with=None, id_starts_with=None, labels_every=None, labels_none=None, labels_some=None, local_id=None, local_id_contains=None, local_id_ends_with=None, local_id_gt=None, local_id_gte=None, local_id_in=None, local_id_lt=None, local_id_lte=None, local_id_not=None, local_id_not_contains=None, local_id_not_ends_with=None, local_id_not_in=None, local_id_not_starts_with=None, local_id_starts_with=None, local_updated_at=None, local_updated_at_gt=None, local_updated_at_gte=None, local_updated_at_in=None, local_updated_at_lt=None, local_updated_at_lte=None, local_updated_at_not=None, local_updated_at_not_in=None, name=None, name_contains=None, name_ends_with=None, name_gt=None, name_gte=None, name_in=None, name_lt=None, name_lte=None, name_not=None, name_not_contains=None, name_not_ends_with=None, name_not_in=None, name_not_starts_with=None, name_starts_with=None, nfs_export=None, _not=None, _or=None, parent_id=None, parent_id_contains=None, parent_id_ends_with=None, parent_id_gt=None, parent_id_gte=None, parent_id_in=None, parent_id_lt=None, parent_id_lte=None, parent_id_not=None, parent_id_not_contains=None, parent_id_not_ends_with=None, parent_id_not_in=None, parent_id_not_starts_with=None, parent_id_starts_with=None, shared_size=None, shared_size_gt=None, shared_size_gte=None, shared_size_in=None, shared_size_lt=None, shared_size_lte=None, shared_size_not=None, shared_size_not_in=None, snapshot_num=None, snapshot_num_gt=None, snapshot_num_gte=None, snapshot_num_in=None, snapshot_num_lt=None, snapshot_num_lte=None, snapshot_num_not=None, snapshot_num_not_in=None, unique_size=None, unique_size_gt=None, unique_size_gte=None, unique_size_in=None, unique_size_lt=None, unique_size_lte=None, unique_size_not=None, unique_size_not_in=None, local_vars_configuration=None):  # noqa: E501
        ...
        self.local_updated_at_gt = local_updated_at_gt
        self.local_updated_at_gte = local_updated_at_gte
        self.local_updated_at_in = local_updated_at_in
        self.local_updated_at_lt = local_updated_at_lt
        self.local_updated_at_lte = local_updated_at_lte
        self.local_updated_at_not = local_updated_at_not
        self.local_updated_at_not_in = local_updated_at_not_in
        self.name = name
        ...
        self.parent_id_contains = parent_id_contains
        self.parent_id_ends_with = parent_id_ends_with
        self.parent_id_gt = parent_id_gt
        self.parent_id_gte = parent_id_gte
        self.parent_id_in = parent_id_in
        self.parent_id_lt = parent_id_lt
        self.parent_id_lte = parent_id_lte
        self.parent_id_not = parent_id_not
        self.parent_id_not_contains = parent_id_not_contains
        self.parent_id_not_ends_with = parent_id_not_ends_with
        self.parent_id_not_in = parent_id_not_in
        self.parent_id_not_starts_with = parent_id_not_starts_with
        self.parent_id_starts_with = parent_id_starts_with
