...
class Vlan(object):
    ...
    def __init__(self, entity_async_status=None, gateway_ip=None, gateway_subnetmask=None, id=None, labels=None, local_id=None, name=None, subnetmask=None, type=None, vds=None, vlan_id=None, vm_nics=None, local_vars_configuration=None):  # noqa: E501
