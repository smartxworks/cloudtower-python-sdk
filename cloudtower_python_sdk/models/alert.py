...
class Alert(object):
    ...
    def __init__(self, alert_rule=None, cause=None, cluster=None, create_time=None, disk=None, ended=None, host=None, id=None, impact=None, labels=None, local_create_time=None, local_end_time=None, local_id=None, local_start_time=None, local_update_time=None, message=None, severity=None, solution=None, threshold=None, value=None, vms=None, local_vars_configuration=None):  # noqa: E501
