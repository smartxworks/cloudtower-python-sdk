...
class Application(object):
    ...
    def __init__(self, cluster=None, error_message=None, id=None, image_name=None, local_id=None, memory=None, state=None, storage_ip=None, type=None, update_time=None, vcpu=None, version=None, vm=None, volume_size=None, local_vars_configuration=None):  # noqa: E501
