...
class BackupTargetExecution(object):
    ...
    def __init__(self, backup_group=None, backup_plan_execution=None, backup_restore_point=None, cluster_local_id=None, duration=None, entity_async_status=None, executed_at=None, id=None, local_id=None, parent_backup=None, read_bytes=None, status=None, total_bytes=None, type=None, vm=None, vm_local_id=None, vm_name=None, local_vars_configuration=None):  # noqa: E501
