...
class VmNicWhereInput(object):
    ...
    def __init__(self, _and=None, enabled=None, enabled_not=None, gateway=None, gateway_contains=None, gateway_ends_with=None, gateway_gt=None, gateway_gte=None, gateway_in=None, gateway_lt=None, gateway_lte=None, gateway_not=None, gateway_not_contains=None, gateway_not_ends_with=None, gateway_not_in=None, gateway_not_starts_with=None, gateway_starts_with=None, id=None, id_contains=None, id_ends_with=None, id_gt=None, id_gte=None, id_in=None, id_lt=None, id_lte=None, id_not=None, id_not_contains=None, id_not_ends_with=None, id_not_in=None, id_not_starts_with=None, id_starts_with=None, interface_id=None, interface_id_contains=None, interface_id_ends_with=None, interface_id_gt=None, interface_id_gte=None, interface_id_in=None, interface_id_lt=None, interface_id_lte=None, interface_id_not=None, interface_id_not_contains=None, interface_id_not_ends_with=None, interface_id_not_in=None, interface_id_not_starts_with=None, interface_id_starts_with=None, ip_address=None, ip_address_contains=None, ip_address_ends_with=None, ip_address_gt=None, ip_address_gte=None, ip_address_in=None, ip_address_lt=None, ip_address_lte=None, ip_address_not=None, ip_address_not_contains=None, ip_address_not_ends_with=None, ip_address_not_in=None, ip_address_not_starts_with=None, ip_address_starts_with=None, local_id=None, local_id_contains=None, local_id_ends_with=None, local_id_gt=None, local_id_gte=None, local_id_in=None, local_id_lt=None, local_id_lte=None, local_id_not=None, local_id_not_contains=None, local_id_not_ends_with=None, local_id_not_in=None, local_id_not_starts_with=None, local_id_starts_with=None, mac_address=None, mac_address_contains=None, mac_address_ends_with=None, mac_address_gt=None, mac_address_gte=None, mac_address_in=None, mac_address_lt=None, mac_address_lte=None, mac_address_not=None, mac_address_not_contains=None, mac_address_not_ends_with=None, mac_address_not_in=None, mac_address_not_starts_with=None, mac_address_starts_with=None, mirror=None, mirror_not=None, model=None, model_in=None, model_not=None, model_not_in=None, nic=None, _not=None, _or=None, order=None, order_gt=None, order_gte=None, order_in=None, order_lt=None, order_lte=None, order_not=None, order_not_in=None, subnet_mask=None, subnet_mask_contains=None, subnet_mask_ends_with=None, subnet_mask_gt=None, subnet_mask_gte=None, subnet_mask_in=None, subnet_mask_lt=None, subnet_mask_lte=None, subnet_mask_not=None, subnet_mask_not_contains=None, subnet_mask_not_ends_with=None, subnet_mask_not_in=None, subnet_mask_not_starts_with=None, subnet_mask_starts_with=None, vlan=None, vm=None, local_vars_configuration=None):  # noqa: E501
        ...
        self.interface_id_contains = interface_id_contains
        self.interface_id_ends_with = interface_id_ends_with
        self.interface_id_gt = interface_id_gt
        self.interface_id_gte = interface_id_gte
        self.interface_id_in = interface_id_in
        self.interface_id_lt = interface_id_lt
        self.interface_id_lte = interface_id_lte
        self.interface_id_not = interface_id_not
        self.interface_id_not_contains = interface_id_not_contains
        self.interface_id_not_ends_with = interface_id_not_ends_with
        self.interface_id_not_in = interface_id_not_in
        self.interface_id_not_starts_with = interface_id_not_starts_with
        self.interface_id_starts_with = interface_id_starts_with
        ...
        self._or = _or
        self.order = order
        self.order_gt = order_gt
        self.order_gte = order_gte
        self.order_in = order_in
        self.order_lt = order_lt
        self.order_lte = order_lte
        self.order_not = order_not
        self.order_not_in = order_not_in
