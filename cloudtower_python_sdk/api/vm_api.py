...
class VmApi(object):
    ...
    def force_shut_down_vm(self, vm_operate_params, **kwargs):  # noqa: E501
        """force_shut_down_vm  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.force_shut_down_vm(vm_operate_params, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.force_shut_down_vm_with_http_info(vm_operate_params, **kwargs)  # noqa: E501

    def force_shut_down_vm_with_http_info(self, vm_operate_params, **kwargs):  # noqa: E501
        """force_shut_down_vm  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.force_shut_down_vm_with_http_info(vm_operate_params, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method force_shut_down_vm" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'vm_operate_params' is set
        if self.api_client.client_side_validation and ('vm_operate_params' not in local_var_params or  # noqa: E501
                                                        local_var_params['vm_operate_params'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `vm_operate_params` when calling `force_shut_down_vm`")  # noqa: E501
