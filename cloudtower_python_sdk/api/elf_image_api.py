...
class ElfImageApi(object):
    ...
    def create_elf_image(self, file, cluster_id, name, size, description, upload_task_id, **kwargs):  # noqa: E501
        """create_elf_image  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_elf_image(file, cluster_id, name, size, description, upload_task_id, async_req=True)
        >>> result = thread.get()
        ...
        return self.create_elf_image_with_http_info(file, cluster_id, name, size, description, upload_task_id, **kwargs)  # noqa: E501

    def create_elf_image_with_http_info(self, file, cluster_id, name, size, description, upload_task_id, **kwargs):  # noqa: E501
        """create_elf_image  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_elf_image_with_http_info(file, cluster_id, name, size, description, upload_task_id, async_req=True)
        >>> result = thread.get()
        ...
        # verify the required parameter 'upload_task_id' is set
        if self.api_client.client_side_validation and ('upload_task_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['upload_task_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `upload_task_id` when calling `create_elf_image`")  # noqa: E501
