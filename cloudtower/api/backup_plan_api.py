...
class BackupPlanApi(object):
    ...
    def get_backup_plan_without_executions(self, get_backup_plans_request_body, **kwargs):  # noqa: E501
        """get_backup_plan_without_executions  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_backup_plan_without_executions(get_backup_plans_request_body, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_backup_plan_without_executions_with_http_info(get_backup_plans_request_body, **kwargs)  # noqa: E501

    def get_backup_plan_without_executions_with_http_info(self, get_backup_plans_request_body, **kwargs):  # noqa: E501
        """get_backup_plan_without_executions  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_backup_plan_without_executions_with_http_info(get_backup_plans_request_body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_backup_plan_without_executions" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        if self.api_client.client_side_validation and ('get_backup_plans_request_body' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `get_backup_plans_request_body` when calling `get_backup_plan_without_executions`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/get-backup-plans-without-executions', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_backup_restore_point_metadata(self, get_backup_restore_point_metadata_request_body, **kwargs):  # noqa: E501
        """get_backup_restore_point_metadata  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_backup_restore_point_metadata(get_backup_restore_point_metadata_request_body, async_req=True)
        >>> result = thread.get()

        :param get_backup_restore_point_metadata_request_body: (required)
        :type get_backup_restore_point_metadata_request_body: GetBackupRestorePointMetadataRequestBody
        :param external_cloudtower_id:
        :type external_cloudtower_id: str
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_backup_restore_point_metadata_with_http_info(get_backup_restore_point_metadata_request_body, **kwargs)  # noqa: E501

    def get_backup_restore_point_metadata_with_http_info(self, get_backup_restore_point_metadata_request_body, **kwargs):  # noqa: E501
        """get_backup_restore_point_metadata  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_backup_restore_point_metadata_with_http_info(get_backup_restore_point_metadata_request_body, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(VmMetaData, status_code(int), headers(HTTPHeaderDict))
        """

        local_var_params = locals()

        all_params = [
            'get_backup_restore_point_metadata_request_body',
            'external_cloudtower_id'
        ]
        all_params.extend(
            [
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_backup_restore_point_metadata" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'get_backup_restore_point_metadata_request_body' is set
        if self.api_client.client_side_validation and ('get_backup_restore_point_metadata_request_body' not in local_var_params or  # noqa: E501
                                                        local_var_params['get_backup_restore_point_metadata_request_body'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `get_backup_restore_point_metadata_request_body` when calling `get_backup_restore_point_metadata`")  # noqa: E501
        ...
        body_params = None
        if 'get_backup_restore_point_metadata_request_body' in local_var_params:
            body_params = local_var_params['get_backup_restore_point_metadata_request_body']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
        ...
        return self.api_client.call_api(
            '/get-backup-restore-point-metadata', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
