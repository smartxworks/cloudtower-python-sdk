...
class VmApi(object):
    ...
    def download_nvram(self, nvram_params, **kwargs):  # noqa: E501
        """download_nvram  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.download_nvram(nvram_params, async_req=True)
        >>> result = thread.get()

        :param nvram_params: (required)
        :type nvram_params: NvramParams
        :param content_language:
        :type content_language: ContentLanguage
        :param external_cloudtower_id:
        :type external_cloudtower_id: str
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: NvramDownloadResponse
        """
        kwargs['_return_http_data_only'] = True
        return self.download_nvram_with_http_info(nvram_params, **kwargs)  # noqa: E501

    def download_nvram_with_http_info(self, nvram_params, **kwargs):  # noqa: E501
        """download_nvram  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.download_nvram_with_http_info(nvram_params, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(NvramDownloadResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method download_nvram" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'nvram_params' is set
        if self.api_client.client_side_validation and ('nvram_params' not in local_var_params or  # noqa: E501
                                                        local_var_params['nvram_params'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `nvram_params` when calling `download_nvram`")  # noqa: E501
        ...
        body_params = None
        if 'nvram_params' in local_var_params:
            body_params = local_var_params['nvram_params']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
    ...
    def upload_nvram(self, nvram_params, **kwargs):  # noqa: E501
        """upload_nvram  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.upload_nvram(nvram_params, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.upload_nvram_with_http_info(nvram_params, **kwargs)  # noqa: E501

    def upload_nvram_with_http_info(self, nvram_params, **kwargs):  # noqa: E501
        """upload_nvram  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.upload_nvram_with_http_info(nvram_params, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('nvram_params' not in local_var_params or  # noqa: E501
                                                        local_var_params['nvram_params'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `nvram_params` when calling `upload_nvram`")  # noqa: E501
