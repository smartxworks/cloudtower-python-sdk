...
class VirtualPrivateCloudFloatingIpApi(object):
    ...
    def batch_create_virtual_private_cloud_floating_ips(self, batch_create_virtual_private_cloud_floating_ips_params, **kwargs):  # noqa: E501
        """batch_create_virtual_private_cloud_floating_ips  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.batch_create_virtual_private_cloud_floating_ips(batch_create_virtual_private_cloud_floating_ips_params, async_req=True)
        >>> result = thread.get()

        :param batch_create_virtual_private_cloud_floating_ips_params: (required)
        :type batch_create_virtual_private_cloud_floating_ips_params: BatchCreateVirtualPrivateCloudFloatingIpsParams
        ...
        :rtype: list[WithTaskBatchCreateVirtualPrivateCloudFloatingIp]
        """
        kwargs['_return_http_data_only'] = True
        return self.batch_create_virtual_private_cloud_floating_ips_with_http_info(batch_create_virtual_private_cloud_floating_ips_params, **kwargs)  # noqa: E501

    def batch_create_virtual_private_cloud_floating_ips_with_http_info(self, batch_create_virtual_private_cloud_floating_ips_params, **kwargs):  # noqa: E501
        """batch_create_virtual_private_cloud_floating_ips  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.batch_create_virtual_private_cloud_floating_ips_with_http_info(batch_create_virtual_private_cloud_floating_ips_params, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(list[WithTaskBatchCreateVirtualPrivateCloudFloatingIp], status_code(int), headers(HTTPHeaderDict))
        """

        local_var_params = locals()

        all_params = [
            'batch_create_virtual_private_cloud_floating_ips_params',
            'content_language'
        ]
        all_params.extend(
            [
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method batch_create_virtual_private_cloud_floating_ips" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'batch_create_virtual_private_cloud_floating_ips_params' is set
        if self.api_client.client_side_validation and ('batch_create_virtual_private_cloud_floating_ips_params' not in local_var_params or  # noqa: E501
                                                        local_var_params['batch_create_virtual_private_cloud_floating_ips_params'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `batch_create_virtual_private_cloud_floating_ips_params` when calling `batch_create_virtual_private_cloud_floating_ips`")  # noqa: E501
        ...
        body_params = None
        if 'batch_create_virtual_private_cloud_floating_ips_params' in local_var_params:
            body_params = local_var_params['batch_create_virtual_private_cloud_floating_ips_params']
        # HTTP header `Accept`
        ...
        response_types_map = {
            200: "list[WithTaskBatchCreateVirtualPrivateCloudFloatingIp]",
            400: "ErrorBody",
            404: "ErrorBody",
            500: "ErrorBody",
        }
        ...
        return self.api_client.call_api(
            '/batch-create-virtual-private-cloud-floating-ips', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
