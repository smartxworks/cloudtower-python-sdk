...
class SnmpTrapReceiver(object):
    ...
    def __init__(self, auth_pass_phrase=None, auth_protocol=None, cluster=None, community=None, disabled=None, engine_id=None, entity_async_status=None, host=None, id=None, inform=None, language_code=None, local_id=None, name=None, port=None, privacy_pass_phrase=None, privacy_protocol=None, protocol=None, username=None, version=None, local_vars_configuration=None):  # noqa: E501
