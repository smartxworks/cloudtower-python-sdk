...
class BackupTargetExecutionOrderByInput(object):
    ...
    allowable_values = [BACKUP_GROUP_ASC, BACKUP_GROUP_DESC, CLUSTER_LOCAL_ID_ASC, CLUSTER_LOCAL_ID_DESC, CREATEDAT_ASC, CREATEDAT_DESC, DURATION_ASC, DURATION_DESC, ENTITYASYNCSTATUS_ASC, ENTITYASYNCSTATUS_DESC, EXECUTED_AT_ASC, EXECUTED_AT_DESC, ID_ASC, ID_DESC, LOCAL_ID_ASC, LOCAL_ID_DESC, PARENT_BACKUP_ASC, PARENT_BACKUP_DESC, READ_BYTES_ASC, READ_BYTES_DESC, RESOURCE_VERSION_ASC, RESOURCE_VERSION_DESC, STATUS_ASC, STATUS_DESC, TOTAL_BYTES_ASC, TOTAL_BYTES_DESC, TYPE_ASC, TYPE_DESC, UPDATEDAT_ASC, UPDATEDAT_DESC, VM_LOCAL_ID_ASC, VM_LOCAL_ID_DESC, VM_NAME_ASC, VM_NAME_DESC]  # noqa: E501
