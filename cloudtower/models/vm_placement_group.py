...
class VmPlacementGroup(object):
    ...
    def __init__(self, cluster=None, description=None, enabled=None, entity_async_status=None, id=None, local_created_at=None, local_id=None, local_updated_at=None, name=None, vm_host_must_enabled=None, vm_host_must_host_uuids=None, vm_host_must_policy=None, vm_host_prefer_enabled=None, vm_host_prefer_host_uuids=None, vm_host_prefer_policy=None, vm_vm_policy=None, vm_vm_policy_enabled=None, vms=None, local_vars_configuration=None):  # noqa: E501
        ...
        self.vm_host_must_host_uuids = vm_host_must_host_uuids
        self.vm_host_must_policy = vm_host_must_policy
        self.vm_host_prefer_enabled = vm_host_prefer_enabled
        self.vm_host_prefer_host_uuids = vm_host_prefer_host_uuids
