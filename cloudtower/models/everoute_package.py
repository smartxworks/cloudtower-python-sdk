...
class EveroutePackage(object):
    ...
    def __init__(self, arch=None, description=None, entity_async_status=None, id=None, local_created_at=None, name=None, package_info=None, size=None, upload_task=None, version=None, local_vars_configuration=None):  # noqa: E501
