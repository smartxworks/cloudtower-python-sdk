...
class UsbDevice(object):
    ...
    def __init__(self, binded=None, description=None, host=None, id=None, local_created_at=None, local_id=None, manufacturer=None, name=None, size=None, status=None, usb_type=None, vm=None, local_vars_configuration=None):  # noqa: E501
