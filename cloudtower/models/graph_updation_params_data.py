...
class GraphUpdationParamsData(object):
    ...
    def __init__(self, instance_ids=None, luns=None, vm_nics=None, nics=None, disks=None, vm_volumes=None, vms=None, hosts=None, network=None, cluster=None, service=None, metric_type=None, metric_count=None, type=None, resource_type=None, title=None, metric_name=None, connect_id=None, local_vars_configuration=None):  # noqa: E501
