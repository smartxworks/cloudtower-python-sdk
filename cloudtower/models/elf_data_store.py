...
class ElfDataStore(object):
    ...
    def __init__(self, cluster=None, description=None, external_use=None, id=None, internal=None, ip_whitelist=None, iscsi_target=None, local_id=None, name=None, nfs_export=None, nvmf_subsystem=None, replica_num=None, thin_provision=None, type=None, local_vars_configuration=None):  # noqa: E501
