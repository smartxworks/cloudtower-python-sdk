...
class PmemDimmWhereInput(object):
    ...
    openapi_types = {
        ...
        'capacity_gt': 'float',
        'capacity_gte': 'float',
        'capacity_in': 'list[float]',
        'capacity_lt': 'float',
        'capacity_lte': 'float',
        'capacity_not': 'float',
        'capacity_not_in': 'list[float]',
        'device_locator': 'str',
    ...
    def __init__(self, _and=None, capacity=None, capacity_gt=None, capacity_gte=None, capacity_in=None, capacity_lt=None, capacity_lte=None, capacity_not=None, capacity_not_in=None, device_locator=None, device_locator_contains=None, device_locator_ends_with=None, device_locator_gt=None, device_locator_gte=None, device_locator_in=None, device_locator_lt=None, device_locator_lte=None, device_locator_not=None, device_locator_not_contains=None, device_locator_not_ends_with=None, device_locator_not_in=None, device_locator_not_starts_with=None, device_locator_starts_with=None, disk=None, health_status=None, health_status_in=None, health_status_not=None, health_status_not_in=None, host=None, id=None, id_contains=None, id_ends_with=None, id_gt=None, id_gte=None, id_in=None, id_lt=None, id_lte=None, id_not=None, id_not_contains=None, id_not_ends_with=None, id_not_in=None, id_not_starts_with=None, id_starts_with=None, local_id=None, local_id_contains=None, local_id_ends_with=None, local_id_gt=None, local_id_gte=None, local_id_in=None, local_id_lt=None, local_id_lte=None, local_id_not=None, local_id_not_contains=None, local_id_not_ends_with=None, local_id_not_in=None, local_id_not_starts_with=None, local_id_starts_with=None, name=None, name_contains=None, name_ends_with=None, name_gt=None, name_gte=None, name_in=None, name_lt=None, name_lte=None, name_not=None, name_not_contains=None, name_not_ends_with=None, name_not_in=None, name_not_starts_with=None, name_starts_with=None, _not=None, numa_node=None, numa_node_gt=None, numa_node_gte=None, numa_node_in=None, numa_node_lt=None, numa_node_lte=None, numa_node_not=None, numa_node_not_in=None, _or=None, part_number=None, part_number_contains=None, part_number_ends_with=None, part_number_gt=None, part_number_gte=None, part_number_in=None, part_number_lt=None, part_number_lte=None, part_number_not=None, part_number_not_contains=None, part_number_not_ends_with=None, part_number_not_in=None, part_number_not_starts_with=None, part_number_starts_with=None, remaining_life_percent=None, remaining_life_percent_gt=None, remaining_life_percent_gte=None, remaining_life_percent_in=None, remaining_life_percent_lt=None, remaining_life_percent_lte=None, remaining_life_percent_not=None, remaining_life_percent_not_in=None, version=None, version_contains=None, version_ends_with=None, version_gt=None, version_gte=None, version_in=None, version_lt=None, version_lte=None, version_not=None, version_not_contains=None, version_not_ends_with=None, version_not_in=None, version_not_starts_with=None, version_starts_with=None, local_vars_configuration=None):  # noqa: E501
        ...
        self.capacity_gt = capacity_gt
        self.capacity_gte = capacity_gte
        self.capacity_in = capacity_in
        self.capacity_lt = capacity_lt
        self.capacity_lte = capacity_lte
        self.capacity_not = capacity_not
        self.capacity_not_in = capacity_not_in
        self.device_locator = device_locator
        self.device_locator_contains = device_locator_contains
        self.device_locator_ends_with = device_locator_ends_with
        self.device_locator_gt = device_locator_gt
        self.device_locator_gte = device_locator_gte
        self.device_locator_in = device_locator_in
        self.device_locator_lt = device_locator_lt
        self.device_locator_lte = device_locator_lte
        self.device_locator_not = device_locator_not
        self.device_locator_not_contains = device_locator_not_contains
        self.device_locator_not_ends_with = device_locator_not_ends_with
        self.device_locator_not_in = device_locator_not_in
        self.device_locator_not_starts_with = device_locator_not_starts_with
        self.device_locator_starts_with = device_locator_starts_with
        self.disk = disk
        ...
        self.part_number_contains = part_number_contains
        self.part_number_ends_with = part_number_ends_with
        self.part_number_gt = part_number_gt
        self.part_number_gte = part_number_gte
        self.part_number_in = part_number_in
        self.part_number_lt = part_number_lt
        self.part_number_lte = part_number_lte
        self.part_number_not = part_number_not
        self.part_number_not_contains = part_number_not_contains
        self.part_number_not_ends_with = part_number_not_ends_with
        self.part_number_not_in = part_number_not_in
        self.part_number_not_starts_with = part_number_not_starts_with
        self.part_number_starts_with = part_number_starts_with
    ...
    def capacity_not_in(self, capacity_not_in):
        ...
        :type capacity_not_in: list[float]
        """
