...
class ClusterUpgradeHistory(object):
    ...
    def __init__(self, cluster=None, date=None, id=None, local_id=None, progress=None, result=None, task_uuid=None, version=None, local_vars_configuration=None):  # noqa: E501
