...
class NestedMetroAvailabilityChecklist(object):
    ...
    def __init__(self, primary_zone=None, primary_zone_and_witness=None, secondary_zone=None, secondary_zone_and_witness=None, witness=None, zone_and_zone=None, local_vars_configuration=None):  # noqa: E501
        ...
        self.primary_zone_and_witness = primary_zone_and_witness
        self.secondary_zone = secondary_zone
        self.secondary_zone_and_witness = secondary_zone_and_witness
        self.witness = witness
        self.zone_and_zone = zone_and_zone
