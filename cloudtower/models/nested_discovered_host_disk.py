...
class NestedDiscoveredHostDisk(object):
    ...
    def __init__(self, dimm_ids=None, drive=None, function=None, model=None, numa_node=None, persistent_memory_type=None, serial=None, size=None, type=None, local_vars_configuration=None):  # noqa: E501
