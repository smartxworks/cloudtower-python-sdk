...
class EntityFilterOrderByInput(object):
    ...
    allowable_values = [APPLY_TO_ALL_CLUSTERS_ASC, APPLY_TO_ALL_CLUSTERS_DESC, ENTITY_TYPE_ASC, ENTITY_TYPE_DESC, FILTER_STATUS_ASC, FILTER_STATUS_DESC, ID_ASC, ID_DESC, LAST_EXECUTED_AT_ASC, LAST_EXECUTED_AT_DESC, NAME_ASC, NAME_DESC, PRESET_ASC, PRESET_DESC, RULES_ASC, RULES_DESC]  # noqa: E501
