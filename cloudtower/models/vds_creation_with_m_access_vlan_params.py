...
class VdsCreationWithMAccessVlanParams(object):
    ...
    def __init__(self, nic_ids=None, cluster_id=None, work_mode=None, bond_mode=None, name=None, vlan=None, local_vars_configuration=None):  # noqa: E501
