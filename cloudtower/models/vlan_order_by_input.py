...
class VlanOrderByInput(object):
    ...
    allowable_values = [ENTITYASYNCSTATUS_ASC, ENTITYASYNCSTATUS_DESC, GATEWAY_IP_ASC, GATEWAY_IP_DESC, GATEWAY_SUBNETMASK_ASC, GATEWAY_SUBNETMASK_DESC, ID_ASC, ID_DESC, LOCAL_ID_ASC, LOCAL_ID_DESC, MODE_TYPE_ASC, MODE_TYPE_DESC, NAME_ASC, NAME_DESC, QOS_BURST_ASC, QOS_BURST_DESC, QOS_MAX_BANDWIDTH_ASC, QOS_MAX_BANDWIDTH_DESC, QOS_MIN_BANDWIDTH_ASC, QOS_MIN_BANDWIDTH_DESC, QOS_PRIORITY_ASC, QOS_PRIORITY_DESC, SUBNETMASK_ASC, SUBNETMASK_DESC, TYPE_ASC, TYPE_DESC, VLAN_ID_ASC, VLAN_ID_DESC]  # noqa: E501
