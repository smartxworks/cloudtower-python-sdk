...
class ZoneTopo(object):
    ...
    def __init__(self, cluster=None, cluster_topo=None, id=None, local_id=None, rack_topoes=None, local_vars_configuration=None):  # noqa: E501
