...
class NestedEverouteClusterControllerStatus(object):
    ...
    def __init__(self, current_number=None, elf_cluster_number=None, expect_number=None, instances=None, number_health=None, local_vars_configuration=None):  # noqa: E501
