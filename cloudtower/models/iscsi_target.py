...
class IscsiTarget(object):
    ...
    def __init__(self, bps=None, bps_max=None, bps_max_length=None, bps_rd=None, bps_rd_max=None, bps_rd_max_length=None, bps_wr=None, bps_wr_max=None, bps_wr_max_length=None, chap_enabled=None, chap_name=None, chap_secret=None, cluster=None, description=None, entity_async_status=None, external_use=None, id=None, initiator_chaps=None, internal=None, io_size=None, iops=None, iops_max=None, iops_max_length=None, iops_rd=None, iops_rd_max=None, iops_rd_max_length=None, iops_wr=None, iops_wr_max=None, iops_wr_max_length=None, ip_whitelist=None, iqn_name=None, iqn_whitelist=None, labels=None, local_id=None, luns=None, name=None, replica_num=None, stripe_num=None, stripe_size=None, thin_provision=None, local_vars_configuration=None):  # noqa: E501
