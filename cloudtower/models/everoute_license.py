...
class EverouteLicense(object):
    ...
    def __init__(self, code=None, expire_date=None, id=None, max_socket_num=None, serial=None, sign_date=None, software_edition=None, type=None, uid=None, local_vars_configuration=None):  # noqa: E501
