...
class ClusterUpgradeHistoryWhereInput(object):
    ...
    def __init__(self, _and=None, cluster=None, date=None, date_gt=None, date_gte=None, date_in=None, date_lt=None, date_lte=None, date_not=None, date_not_in=None, id=None, id_contains=None, id_ends_with=None, id_gt=None, id_gte=None, id_in=None, id_lt=None, id_lte=None, id_not=None, id_not_contains=None, id_not_ends_with=None, id_not_in=None, id_not_starts_with=None, id_starts_with=None, local_id=None, local_id_contains=None, local_id_ends_with=None, local_id_gt=None, local_id_gte=None, local_id_in=None, local_id_lt=None, local_id_lte=None, local_id_not=None, local_id_not_contains=None, local_id_not_ends_with=None, local_id_not_in=None, local_id_not_starts_with=None, local_id_starts_with=None, _not=None, _or=None, result=None, result_contains=None, result_ends_with=None, result_gt=None, result_gte=None, result_in=None, result_lt=None, result_lte=None, result_not=None, result_not_contains=None, result_not_ends_with=None, result_not_in=None, result_not_starts_with=None, result_starts_with=None, task_uuid=None, task_uuid_contains=None, task_uuid_ends_with=None, task_uuid_gt=None, task_uuid_gte=None, task_uuid_in=None, task_uuid_lt=None, task_uuid_lte=None, task_uuid_not=None, task_uuid_not_contains=None, task_uuid_not_ends_with=None, task_uuid_not_in=None, task_uuid_not_starts_with=None, task_uuid_starts_with=None, version=None, version_contains=None, version_ends_with=None, version_gt=None, version_gte=None, version_in=None, version_lt=None, version_lte=None, version_not=None, version_not_contains=None, version_not_ends_with=None, version_not_in=None, version_not_starts_with=None, version_starts_with=None, local_vars_configuration=None):  # noqa: E501
        ...
        self.date = date
        self.date_gt = date_gt
        self.date_gte = date_gte
        self.date_in = date_in
        self.date_lt = date_lt
        self.date_lte = date_lte
        self.date_not = date_not
        self.date_not_in = date_not_in
        self.id = id
        ...
        self._or = _or
        self.result = result
        self.result_contains = result_contains
        self.result_ends_with = result_ends_with
        self.result_gt = result_gt
        self.result_gte = result_gte
        self.result_in = result_in
        self.result_lt = result_lt
        self.result_lte = result_lte
        self.result_not = result_not
        self.result_not_contains = result_not_contains
        self.result_not_ends_with = result_not_ends_with
        self.result_not_in = result_not_in
        self.result_not_starts_with = result_not_starts_with
        self.result_starts_with = result_starts_with
        self.task_uuid = task_uuid
        self.task_uuid_contains = task_uuid_contains
        self.task_uuid_ends_with = task_uuid_ends_with
        self.task_uuid_gt = task_uuid_gt
        self.task_uuid_gte = task_uuid_gte
        self.task_uuid_in = task_uuid_in
        self.task_uuid_lt = task_uuid_lt
        self.task_uuid_lte = task_uuid_lte
        self.task_uuid_not = task_uuid_not
        self.task_uuid_not_contains = task_uuid_not_contains
        self.task_uuid_not_ends_with = task_uuid_not_ends_with
        self.task_uuid_not_in = task_uuid_not_in
        self.task_uuid_not_starts_with = task_uuid_not_starts_with
        self.task_uuid_starts_with = task_uuid_starts_with
