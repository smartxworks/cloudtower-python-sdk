...
class DiskWhereInput(object):
    ...
    def __init__(self, _and=None, entity_async_status=None, entity_async_status_in=None, entity_async_status_not=None, entity_async_status_not_in=None, firmware=None, firmware_contains=None, firmware_ends_with=None, firmware_gt=None, firmware_gte=None, firmware_in=None, firmware_lt=None, firmware_lte=None, firmware_not=None, firmware_not_contains=None, firmware_not_ends_with=None, firmware_not_in=None, firmware_not_starts_with=None, firmware_starts_with=None, function=None, function_in=None, function_not=None, function_not_in=None, health_status=None, health_status_in=None, health_status_not=None, health_status_not_in=None, healthy=None, healthy_not=None, host=None, id=None, id_contains=None, id_ends_with=None, id_gt=None, id_gte=None, id_in=None, id_lt=None, id_lte=None, id_not=None, id_not_contains=None, id_not_ends_with=None, id_not_in=None, id_not_starts_with=None, id_starts_with=None, labels_every=None, labels_none=None, labels_some=None, local_id=None, local_id_contains=None, local_id_ends_with=None, local_id_gt=None, local_id_gte=None, local_id_in=None, local_id_lt=None, local_id_lte=None, local_id_not=None, local_id_not_contains=None, local_id_not_ends_with=None, local_id_not_in=None, local_id_not_starts_with=None, local_id_starts_with=None, model=None, model_contains=None, model_ends_with=None, model_gt=None, model_gte=None, model_in=None, model_lt=None, model_lte=None, model_not=None, model_not_contains=None, model_not_ends_with=None, model_not_in=None, model_not_starts_with=None, model_starts_with=None, mounted=None, mounted_not=None, name=None, name_contains=None, name_ends_with=None, name_gt=None, name_gte=None, name_in=None, name_lt=None, name_lte=None, name_not=None, name_not_contains=None, name_not_ends_with=None, name_not_in=None, name_not_starts_with=None, name_starts_with=None, _not=None, numa_node=None, numa_node_gt=None, numa_node_gte=None, numa_node_in=None, numa_node_lt=None, numa_node_lte=None, numa_node_not=None, numa_node_not_in=None, offline=None, offline_not=None, _or=None, path=None, path_contains=None, path_ends_with=None, path_gt=None, path_gte=None, path_in=None, path_lt=None, path_lte=None, path_not=None, path_not_contains=None, path_not_ends_with=None, path_not_in=None, path_not_starts_with=None, path_starts_with=None, persistent_memory_type=None, persistent_memory_type_contains=None, persistent_memory_type_ends_with=None, persistent_memory_type_gt=None, persistent_memory_type_gte=None, persistent_memory_type_in=None, persistent_memory_type_lt=None, persistent_memory_type_lte=None, persistent_memory_type_not=None, persistent_memory_type_not_contains=None, persistent_memory_type_not_ends_with=None, persistent_memory_type_not_in=None, persistent_memory_type_not_starts_with=None, persistent_memory_type_starts_with=None, physical_slot_on_brick=None, physical_slot_on_brick_gt=None, physical_slot_on_brick_gte=None, physical_slot_on_brick_in=None, physical_slot_on_brick_lt=None, physical_slot_on_brick_lte=None, physical_slot_on_brick_not=None, physical_slot_on_brick_not_in=None, pmem_dimms_every=None, pmem_dimms_none=None, pmem_dimms_some=None, recommended_usage=None, recommended_usage_in=None, recommended_usage_not=None, recommended_usage_not_in=None, remaining_life_percent=None, remaining_life_percent_gt=None, remaining_life_percent_gte=None, remaining_life_percent_in=None, remaining_life_percent_lt=None, remaining_life_percent_lte=None, remaining_life_percent_not=None, remaining_life_percent_not_in=None, serial=None, serial_contains=None, serial_ends_with=None, serial_gt=None, serial_gte=None, serial_in=None, serial_lt=None, serial_lte=None, serial_not=None, serial_not_contains=None, serial_not_ends_with=None, serial_not_in=None, serial_not_starts_with=None, serial_starts_with=None, size=None, size_gt=None, size_gte=None, size_in=None, size_lt=None, size_lte=None, size_not=None, size_not_in=None, type=None, type_in=None, type_not=None, type_not_in=None, usage=None, usage_in=None, usage_not=None, usage_not_in=None, usage_status=None, usage_status_in=None, usage_status_not=None, usage_status_not_in=None, local_vars_configuration=None):  # noqa: E501
        ...
        self.firmware_contains = firmware_contains
        self.firmware_ends_with = firmware_ends_with
        self.firmware_gt = firmware_gt
        self.firmware_gte = firmware_gte
        self.firmware_in = firmware_in
        self.firmware_lt = firmware_lt
        self.firmware_lte = firmware_lte
        self.firmware_not = firmware_not
        self.firmware_not_contains = firmware_not_contains
        self.firmware_not_ends_with = firmware_not_ends_with
        self.firmware_not_in = firmware_not_in
        self.firmware_not_starts_with = firmware_not_starts_with
        self.firmware_starts_with = firmware_starts_with
        self.function = function
        self.function_in = function_in
        self.function_not = function_not
        self.function_not_in = function_not_in
        self.health_status = health_status
        self.health_status_in = health_status_in
        self.health_status_not = health_status_not
        self.health_status_not_in = health_status_not_in
        ...
        self.numa_node_gt = numa_node_gt
        self.numa_node_gte = numa_node_gte
        self.numa_node_in = numa_node_in
        self.numa_node_lt = numa_node_lt
        self.numa_node_lte = numa_node_lte
        self.numa_node_not = numa_node_not
        self.numa_node_not_in = numa_node_not_in
        self.offline = offline
        self.offline_not = offline_not
        self._or = _or
        self.path = path
        ...
        self.persistent_memory_type_contains = persistent_memory_type_contains
        self.persistent_memory_type_ends_with = persistent_memory_type_ends_with
        self.persistent_memory_type_gt = persistent_memory_type_gt
        self.persistent_memory_type_gte = persistent_memory_type_gte
        self.persistent_memory_type_in = persistent_memory_type_in
        self.persistent_memory_type_lt = persistent_memory_type_lt
        self.persistent_memory_type_lte = persistent_memory_type_lte
        self.persistent_memory_type_not = persistent_memory_type_not
        self.persistent_memory_type_not_contains = persistent_memory_type_not_contains
        self.persistent_memory_type_not_ends_with = persistent_memory_type_not_ends_with
        self.persistent_memory_type_not_in = persistent_memory_type_not_in
        self.persistent_memory_type_not_starts_with = persistent_memory_type_not_starts_with
        self.persistent_memory_type_starts_with = persistent_memory_type_starts_with
        self.physical_slot_on_brick = physical_slot_on_brick
        self.physical_slot_on_brick_gt = physical_slot_on_brick_gt
        self.physical_slot_on_brick_gte = physical_slot_on_brick_gte
        self.physical_slot_on_brick_in = physical_slot_on_brick_in
        self.physical_slot_on_brick_lt = physical_slot_on_brick_lt
        self.physical_slot_on_brick_lte = physical_slot_on_brick_lte
        self.physical_slot_on_brick_not = physical_slot_on_brick_not
        self.physical_slot_on_brick_not_in = physical_slot_on_brick_not_in
        self.pmem_dimms_every = pmem_dimms_every
        self.pmem_dimms_none = pmem_dimms_none
        self.pmem_dimms_some = pmem_dimms_some
        self.recommended_usage = recommended_usage
        self.recommended_usage_in = recommended_usage_in
        self.recommended_usage_not = recommended_usage_not
        self.recommended_usage_not_in = recommended_usage_not_in
        self.remaining_life_percent = remaining_life_percent
        self.remaining_life_percent_gt = remaining_life_percent_gt
        self.remaining_life_percent_gte = remaining_life_percent_gte
        self.remaining_life_percent_in = remaining_life_percent_in
        self.remaining_life_percent_lt = remaining_life_percent_lt
        self.remaining_life_percent_lte = remaining_life_percent_lte
        self.remaining_life_percent_not = remaining_life_percent_not
        self.remaining_life_percent_not_in = remaining_life_percent_not_in
        self.serial = serial
        ...
        self.usage_not = usage_not
        self.usage_not_in = usage_not_in
        self.usage_status = usage_status
        self.usage_status_in = usage_status_in
        self.usage_status_not = usage_status_not
        self.usage_status_not_in = usage_status_not_in
