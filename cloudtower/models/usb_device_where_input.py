...
class UsbDeviceWhereInput(object):
    ...
    def __init__(self, _and=None, binded=None, binded_not=None, description=None, description_contains=None, description_ends_with=None, description_gt=None, description_gte=None, description_in=None, description_lt=None, description_lte=None, description_not=None, description_not_contains=None, description_not_ends_with=None, description_not_in=None, description_not_starts_with=None, description_starts_with=None, host=None, id=None, id_contains=None, id_ends_with=None, id_gt=None, id_gte=None, id_in=None, id_lt=None, id_lte=None, id_not=None, id_not_contains=None, id_not_ends_with=None, id_not_in=None, id_not_starts_with=None, id_starts_with=None, local_created_at=None, local_created_at_gt=None, local_created_at_gte=None, local_created_at_in=None, local_created_at_lt=None, local_created_at_lte=None, local_created_at_not=None, local_created_at_not_in=None, local_id=None, local_id_contains=None, local_id_ends_with=None, local_id_gt=None, local_id_gte=None, local_id_in=None, local_id_lt=None, local_id_lte=None, local_id_not=None, local_id_not_contains=None, local_id_not_ends_with=None, local_id_not_in=None, local_id_not_starts_with=None, local_id_starts_with=None, manufacturer=None, manufacturer_contains=None, manufacturer_ends_with=None, manufacturer_gt=None, manufacturer_gte=None, manufacturer_in=None, manufacturer_lt=None, manufacturer_lte=None, manufacturer_not=None, manufacturer_not_contains=None, manufacturer_not_ends_with=None, manufacturer_not_in=None, manufacturer_not_starts_with=None, manufacturer_starts_with=None, name=None, name_contains=None, name_ends_with=None, name_gt=None, name_gte=None, name_in=None, name_lt=None, name_lte=None, name_not=None, name_not_contains=None, name_not_ends_with=None, name_not_in=None, name_not_starts_with=None, name_starts_with=None, _not=None, _or=None, size=None, size_gt=None, size_gte=None, size_in=None, size_lt=None, size_lte=None, size_not=None, size_not_in=None, status=None, status_in=None, status_not=None, status_not_in=None, usb_type=None, usb_type_contains=None, usb_type_ends_with=None, usb_type_gt=None, usb_type_gte=None, usb_type_in=None, usb_type_lt=None, usb_type_lte=None, usb_type_not=None, usb_type_not_contains=None, usb_type_not_ends_with=None, usb_type_not_in=None, usb_type_not_starts_with=None, usb_type_starts_with=None, vm=None, local_vars_configuration=None):  # noqa: E501
        ...
        self.manufacturer_contains = manufacturer_contains
        self.manufacturer_ends_with = manufacturer_ends_with
        self.manufacturer_gt = manufacturer_gt
        self.manufacturer_gte = manufacturer_gte
        self.manufacturer_in = manufacturer_in
        self.manufacturer_lt = manufacturer_lt
        self.manufacturer_lte = manufacturer_lte
        self.manufacturer_not = manufacturer_not
        self.manufacturer_not_contains = manufacturer_not_contains
        self.manufacturer_not_ends_with = manufacturer_not_ends_with
        self.manufacturer_not_in = manufacturer_not_in
        self.manufacturer_not_starts_with = manufacturer_not_starts_with
        self.manufacturer_starts_with = manufacturer_starts_with
        self.name = name
        ...
        self.usb_type_contains = usb_type_contains
        self.usb_type_ends_with = usb_type_ends_with
        self.usb_type_gt = usb_type_gt
        self.usb_type_gte = usb_type_gte
        self.usb_type_in = usb_type_in
        self.usb_type_lt = usb_type_lt
        self.usb_type_lte = usb_type_lte
        self.usb_type_not = usb_type_not
        self.usb_type_not_contains = usb_type_not_contains
        self.usb_type_not_ends_with = usb_type_not_ends_with
        self.usb_type_not_in = usb_type_not_in
        self.usb_type_not_starts_with = usb_type_not_starts_with
        self.usb_type_starts_with = usb_type_starts_with
        self.vm = vm
