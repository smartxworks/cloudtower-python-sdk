...
class GlobalSettingsWhereInput(object):
    ...
    def __init__(self, _and=None, id=None, id_contains=None, id_ends_with=None, id_gt=None, id_gte=None, id_in=None, id_lt=None, id_lte=None, id_not=None, id_not_contains=None, id_not_ends_with=None, id_not_in=None, id_not_starts_with=None, id_starts_with=None, _not=None, _or=None, local_vars_configuration=None):  # noqa: E501
