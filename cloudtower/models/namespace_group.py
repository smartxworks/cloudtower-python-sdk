...
class NamespaceGroup(object):
    ...
    def __init__(self, entity_async_status=None, id=None, labels=None, local_create_time=None, local_id=None, name=None, namespaces=None, nvmf_subsystem=None, local_vars_configuration=None):  # noqa: E501
