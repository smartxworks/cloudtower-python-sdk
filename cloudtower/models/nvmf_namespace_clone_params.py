...
class NvmfNamespaceCloneParams(object):
    ...
    def __init__(self, namespace_group_id=None, nvmf_subsystem_id=None, name=None, snapshot_id=None, local_vars_configuration=None):  # noqa: E501
        ...
        if namespace_group_id is not None:
            self.namespace_group_id = namespace_group_id
