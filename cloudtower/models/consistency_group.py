...
class ConsistencyGroup(object):
    ...
    def __init__(self, cluster=None, consistency_group_snapshots=None, description=None, entity_async_status=None, id=None, iscsi_luns=None, labels=None, local_created_at=None, local_id=None, name=None, namespaces=None, unique_size=None, local_vars_configuration=None):  # noqa: E501
