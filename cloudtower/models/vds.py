...
class Vds(object):
    ...
    def __init__(self, bond_mode=None, cluster=None, entity_async_status=None, everoute_cluster=None, id=None, internal=None, labels=None, local_id=None, name=None, nics=None, ovsbr_name=None, type=None, vlans=None, vlans_num=None, work_mode=None, local_vars_configuration=None):  # noqa: E501
