...
class EntityFilterCreationParams(object):
    ...
    def __init__(self, exclude_vms=None, clusters=None, apply_to_all_clusters=None, rules=None, name=None, local_vars_configuration=None):  # noqa: E501
        ...
        if exclude_vms is not None:
            self.exclude_vms = exclude_vms
        if clusters is not None:
            self.clusters = clusters
        if apply_to_all_clusters is not None:
