...
class EverouteClusterWhereInput(object):
    ...
    def __init__(self, agent_elf_clusters_every=None, agent_elf_clusters_none=None, agent_elf_clusters_some=None, agent_elf_vdses_every=None, agent_elf_vdses_none=None, agent_elf_vdses_some=None, _and=None, entity_async_status=None, entity_async_status_in=None, entity_async_status_not=None, entity_async_status_not_in=None, global_default_action=None, global_default_action_in=None, global_default_action_not=None, global_default_action_not_in=None, id=None, id_contains=None, id_ends_with=None, id_gt=None, id_gte=None, id_in=None, id_lt=None, id_lte=None, id_not=None, id_not_contains=None, id_not_ends_with=None, id_not_in=None, id_not_starts_with=None, id_starts_with=None, installed=None, installed_not=None, name=None, name_contains=None, name_ends_with=None, name_gt=None, name_gte=None, name_in=None, name_lt=None, name_lte=None, name_not=None, name_not_contains=None, name_not_ends_with=None, name_not_in=None, name_not_starts_with=None, name_starts_with=None, _not=None, _or=None, phase=None, phase_in=None, phase_not=None, phase_not_in=None, version=None, version_contains=None, version_ends_with=None, version_gt=None, version_gte=None, version_in=None, version_lt=None, version_lte=None, version_not=None, version_not_contains=None, version_not_ends_with=None, version_not_in=None, version_not_starts_with=None, version_starts_with=None, local_vars_configuration=None):  # noqa: E501
        ...
        self.installed_not = installed_not
        self.name = name
