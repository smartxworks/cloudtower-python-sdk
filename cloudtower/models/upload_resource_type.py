...
class UploadResourceType(object):
    ...
    allowable_values = [CLOUDTOWER_APPLICATION_PACKAGE, CLUSTER_IMAGE, CLUSTER_IMAGE_META, CONTENT_LIBRARY_IMAGE, ELF_IMAGE, EVEROUTE_PACKAGE, MONITOR_IMAGE, OVF, SVT_IMAGE, VM_VOLUME_QCOW2, VM_VOLUME_RAW]  # noqa: E501
