...
class VmVolumeSnapshotOrderByInput(object):
    ...
    allowable_values = [CREATEAT_ASC, CREATEAT_DESC, DESCRIPTION_ASC, DESCRIPTION_DESC, ENTITYASYNCSTATUS_ASC, ENTITYASYNCSTATUS_DESC, ID_ASC, ID_DESC, LOCAL_CREATED_AT_ASC, LOCAL_CREATED_AT_DESC, LOCAL_ID_ASC, LOCAL_ID_DESC, NAME_ASC, NAME_DESC, SHARED_SIZE_ASC, SHARED_SIZE_DESC, SIZE_ASC, SIZE_DESC, TYPE_ASC, TYPE_DESC, UNIQUE_SIZE_ASC, UNIQUE_SIZE_DESC, ZBS_SNAPSHOT_UUID_ASC, ZBS_SNAPSHOT_UUID_DESC]  # noqa: E501
    ...
    def __init__(self, **kwargs):  # noqa: E501
        """VmVolumeSnapshotOrderByInput - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VmVolumeSnapshotOrderByInput):
            return False
