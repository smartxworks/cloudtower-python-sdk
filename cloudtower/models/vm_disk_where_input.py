...
class VmDiskWhereInput(object):
    ...
    def __init__(self, _and=None, boot=None, boot_gt=None, boot_gte=None, boot_in=None, boot_lt=None, boot_lte=None, boot_not=None, boot_not_in=None, bus=None, bus_in=None, bus_not=None, bus_not_in=None, cloud_init_image_name=None, cloud_init_image_name_contains=None, cloud_init_image_name_ends_with=None, cloud_init_image_name_gt=None, cloud_init_image_name_gte=None, cloud_init_image_name_in=None, cloud_init_image_name_lt=None, cloud_init_image_name_lte=None, cloud_init_image_name_not=None, cloud_init_image_name_not_contains=None, cloud_init_image_name_not_ends_with=None, cloud_init_image_name_not_in=None, cloud_init_image_name_not_starts_with=None, cloud_init_image_name_starts_with=None, cloud_init_image_path=None, cloud_init_image_path_contains=None, cloud_init_image_path_ends_with=None, cloud_init_image_path_gt=None, cloud_init_image_path_gte=None, cloud_init_image_path_in=None, cloud_init_image_path_lt=None, cloud_init_image_path_lte=None, cloud_init_image_path_not=None, cloud_init_image_path_not_contains=None, cloud_init_image_path_not_ends_with=None, cloud_init_image_path_not_in=None, cloud_init_image_path_not_starts_with=None, cloud_init_image_path_starts_with=None, device=None, device_contains=None, device_ends_with=None, device_gt=None, device_gte=None, device_in=None, device_lt=None, device_lte=None, device_not=None, device_not_contains=None, device_not_ends_with=None, device_not_in=None, device_not_starts_with=None, device_starts_with=None, disabled=None, disabled_not=None, elf_image=None, id=None, id_contains=None, id_ends_with=None, id_gt=None, id_gte=None, id_in=None, id_lt=None, id_lte=None, id_not=None, id_not_contains=None, id_not_ends_with=None, id_not_in=None, id_not_starts_with=None, id_starts_with=None, key=None, key_gt=None, key_gte=None, key_in=None, key_lt=None, key_lte=None, key_not=None, key_not_in=None, max_bandwidth=None, max_bandwidth_gt=None, max_bandwidth_gte=None, max_bandwidth_in=None, max_bandwidth_lt=None, max_bandwidth_lte=None, max_bandwidth_not=None, max_bandwidth_not_in=None, max_bandwidth_policy=None, max_bandwidth_policy_in=None, max_bandwidth_policy_not=None, max_bandwidth_policy_not_in=None, max_iops=None, max_iops_gt=None, max_iops_gte=None, max_iops_in=None, max_iops_lt=None, max_iops_lte=None, max_iops_not=None, max_iops_not_in=None, max_iops_policy=None, max_iops_policy_in=None, max_iops_policy_not=None, max_iops_policy_not_in=None, _not=None, _or=None, serial=None, serial_contains=None, serial_ends_with=None, serial_gt=None, serial_gte=None, serial_in=None, serial_lt=None, serial_lte=None, serial_not=None, serial_not_contains=None, serial_not_ends_with=None, serial_not_in=None, serial_not_starts_with=None, serial_starts_with=None, svt_image=None, type=None, type_in=None, type_not=None, type_not_in=None, unsafe_image_path=None, unsafe_image_path_contains=None, unsafe_image_path_ends_with=None, unsafe_image_path_gt=None, unsafe_image_path_gte=None, unsafe_image_path_in=None, unsafe_image_path_lt=None, unsafe_image_path_lte=None, unsafe_image_path_not=None, unsafe_image_path_not_contains=None, unsafe_image_path_not_ends_with=None, unsafe_image_path_not_in=None, unsafe_image_path_not_starts_with=None, unsafe_image_path_starts_with=None, unsafe_image_uuid=None, unsafe_image_uuid_contains=None, unsafe_image_uuid_ends_with=None, unsafe_image_uuid_gt=None, unsafe_image_uuid_gte=None, unsafe_image_uuid_in=None, unsafe_image_uuid_lt=None, unsafe_image_uuid_lte=None, unsafe_image_uuid_not=None, unsafe_image_uuid_not_contains=None, unsafe_image_uuid_not_ends_with=None, unsafe_image_uuid_not_in=None, unsafe_image_uuid_not_starts_with=None, unsafe_image_uuid_starts_with=None, unsafe_provision=None, unsafe_provision_contains=None, unsafe_provision_ends_with=None, unsafe_provision_gt=None, unsafe_provision_gte=None, unsafe_provision_in=None, unsafe_provision_lt=None, unsafe_provision_lte=None, unsafe_provision_not=None, unsafe_provision_not_contains=None, unsafe_provision_not_ends_with=None, unsafe_provision_not_in=None, unsafe_provision_not_starts_with=None, unsafe_provision_starts_with=None, vm=None, vm_volume=None, local_vars_configuration=None):  # noqa: E501
        ...
        self._and = _and
        self.boot = boot
        self.boot_gt = boot_gt
        self.boot_gte = boot_gte
        self.boot_in = boot_in
        self.boot_lt = boot_lt
        self.boot_lte = boot_lte
        self.boot_not = boot_not
        self.boot_not_in = boot_not_in
        self.bus = bus
        self.bus_in = bus_in
        self.bus_not = bus_not
        self.bus_not_in = bus_not_in
        self.cloud_init_image_name = cloud_init_image_name
        self.cloud_init_image_name_contains = cloud_init_image_name_contains
        self.cloud_init_image_name_ends_with = cloud_init_image_name_ends_with
        self.cloud_init_image_name_gt = cloud_init_image_name_gt
        self.cloud_init_image_name_gte = cloud_init_image_name_gte
        self.cloud_init_image_name_in = cloud_init_image_name_in
        self.cloud_init_image_name_lt = cloud_init_image_name_lt
        self.cloud_init_image_name_lte = cloud_init_image_name_lte
        self.cloud_init_image_name_not = cloud_init_image_name_not
        self.cloud_init_image_name_not_contains = cloud_init_image_name_not_contains
        self.cloud_init_image_name_not_ends_with = cloud_init_image_name_not_ends_with
        self.cloud_init_image_name_not_in = cloud_init_image_name_not_in
        self.cloud_init_image_name_not_starts_with = cloud_init_image_name_not_starts_with
        self.cloud_init_image_name_starts_with = cloud_init_image_name_starts_with
        self.cloud_init_image_path = cloud_init_image_path
        self.cloud_init_image_path_contains = cloud_init_image_path_contains
        self.cloud_init_image_path_ends_with = cloud_init_image_path_ends_with
        self.cloud_init_image_path_gt = cloud_init_image_path_gt
        self.cloud_init_image_path_gte = cloud_init_image_path_gte
        self.cloud_init_image_path_in = cloud_init_image_path_in
        self.cloud_init_image_path_lt = cloud_init_image_path_lt
        self.cloud_init_image_path_lte = cloud_init_image_path_lte
        self.cloud_init_image_path_not = cloud_init_image_path_not
        self.cloud_init_image_path_not_contains = cloud_init_image_path_not_contains
        self.cloud_init_image_path_not_ends_with = cloud_init_image_path_not_ends_with
        self.cloud_init_image_path_not_in = cloud_init_image_path_not_in
        self.cloud_init_image_path_not_starts_with = cloud_init_image_path_not_starts_with
        self.cloud_init_image_path_starts_with = cloud_init_image_path_starts_with
        self.device = device
        self.device_contains = device_contains
        self.device_ends_with = device_ends_with
        self.device_gt = device_gt
        self.device_gte = device_gte
        self.device_in = device_in
        self.device_lt = device_lt
        self.device_lte = device_lte
        self.device_not = device_not
        self.device_not_contains = device_not_contains
        self.device_not_ends_with = device_not_ends_with
        self.device_not_in = device_not_in
        self.device_not_starts_with = device_not_starts_with
        self.device_starts_with = device_starts_with
        ...
        self.unsafe_image_path_contains = unsafe_image_path_contains
        self.unsafe_image_path_ends_with = unsafe_image_path_ends_with
        self.unsafe_image_path_gt = unsafe_image_path_gt
        self.unsafe_image_path_gte = unsafe_image_path_gte
        self.unsafe_image_path_in = unsafe_image_path_in
        self.unsafe_image_path_lt = unsafe_image_path_lt
        self.unsafe_image_path_lte = unsafe_image_path_lte
        self.unsafe_image_path_not = unsafe_image_path_not
        self.unsafe_image_path_not_contains = unsafe_image_path_not_contains
        self.unsafe_image_path_not_ends_with = unsafe_image_path_not_ends_with
        self.unsafe_image_path_not_in = unsafe_image_path_not_in
        self.unsafe_image_path_not_starts_with = unsafe_image_path_not_starts_with
        self.unsafe_image_path_starts_with = unsafe_image_path_starts_with
        self.unsafe_image_uuid = unsafe_image_uuid
        self.unsafe_image_uuid_contains = unsafe_image_uuid_contains
        self.unsafe_image_uuid_ends_with = unsafe_image_uuid_ends_with
        self.unsafe_image_uuid_gt = unsafe_image_uuid_gt
        self.unsafe_image_uuid_gte = unsafe_image_uuid_gte
        self.unsafe_image_uuid_in = unsafe_image_uuid_in
        self.unsafe_image_uuid_lt = unsafe_image_uuid_lt
        self.unsafe_image_uuid_lte = unsafe_image_uuid_lte
        self.unsafe_image_uuid_not = unsafe_image_uuid_not
        self.unsafe_image_uuid_not_contains = unsafe_image_uuid_not_contains
        self.unsafe_image_uuid_not_ends_with = unsafe_image_uuid_not_ends_with
        self.unsafe_image_uuid_not_in = unsafe_image_uuid_not_in
        self.unsafe_image_uuid_not_starts_with = unsafe_image_uuid_not_starts_with
        self.unsafe_image_uuid_starts_with = unsafe_image_uuid_starts_with
        self.unsafe_provision = unsafe_provision
        self.unsafe_provision_contains = unsafe_provision_contains
        self.unsafe_provision_ends_with = unsafe_provision_ends_with
        self.unsafe_provision_gt = unsafe_provision_gt
        self.unsafe_provision_gte = unsafe_provision_gte
        self.unsafe_provision_in = unsafe_provision_in
        self.unsafe_provision_lt = unsafe_provision_lt
        self.unsafe_provision_lte = unsafe_provision_lte
        self.unsafe_provision_not = unsafe_provision_not
        self.unsafe_provision_not_contains = unsafe_provision_not_contains
        self.unsafe_provision_not_ends_with = unsafe_provision_not_ends_with
        self.unsafe_provision_not_in = unsafe_provision_not_in
        self.unsafe_provision_not_starts_with = unsafe_provision_not_starts_with
        self.unsafe_provision_starts_with = unsafe_provision_starts_with
        self.vm = vm
