...
class HostCreationParamsData(object):
    ...
    def __init__(self, ifaces=None, disks=None, platform_password=None, platform_username=None, platform_ip=None, ipmi=None, hostname=None, host_uuid=None, host_ip=None, local_vars_configuration=None):  # noqa: E501
