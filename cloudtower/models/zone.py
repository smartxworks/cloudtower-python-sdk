...
class Zone(object):
    ...
    def __init__(self, cluster=None, datacenter=None, failure_data_space=None, host_num=None, hosts=None, id=None, is_preferred=None, local_id=None, provisioned_cpu_cores=None, provisioned_cpu_cores_for_active_vm=None, provisioned_data_space=None, provisioned_memory_bytes=None, running_vm_num=None, stopped_vm_num=None, suspended_vm_num=None, total_cache_capacity=None, total_cpu_cores=None, total_cpu_hz=None, total_data_capacity=None, total_memory_bytes=None, used_data_space=None, valid_data_space=None, vm_num=None, local_vars_configuration=None):  # noqa: E501
