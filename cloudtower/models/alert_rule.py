...
class AlertRule(object):
    ...
    def __init__(self, cluster=None, customized=None, disabled=None, global_alert_rule=None, id=None, local_id=None, thresholds=None, local_vars_configuration=None):  # noqa: E501
