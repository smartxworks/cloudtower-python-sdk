...
class EntityFilterWhereInput(object):
    ...
    def __init__(self, _and=None, apply_to_all_clusters=None, apply_to_all_clusters_not=None, clusters_every=None, clusters_none=None, clusters_some=None, entity_type=None, entity_type_in=None, entity_type_not=None, entity_type_not_in=None, exec_failed_cluster_every=None, exec_failed_cluster_none=None, exec_failed_cluster_some=None, filter_status=None, filter_status_in=None, filter_status_not=None, filter_status_not_in=None, id=None, id_contains=None, id_ends_with=None, id_gt=None, id_gte=None, id_in=None, id_lt=None, id_lte=None, id_not=None, id_not_contains=None, id_not_ends_with=None, id_not_in=None, id_not_starts_with=None, id_starts_with=None, last_executed_at=None, last_executed_at_gt=None, last_executed_at_gte=None, last_executed_at_in=None, last_executed_at_lt=None, last_executed_at_lte=None, last_executed_at_not=None, last_executed_at_not_in=None, name=None, name_contains=None, name_ends_with=None, name_gt=None, name_gte=None, name_in=None, name_lt=None, name_lte=None, name_not=None, name_not_contains=None, name_not_ends_with=None, name_not_in=None, name_not_starts_with=None, name_starts_with=None, _not=None, _or=None, preset=None, preset_contains=None, preset_ends_with=None, preset_gt=None, preset_gte=None, preset_in=None, preset_lt=None, preset_lte=None, preset_not=None, preset_not_contains=None, preset_not_ends_with=None, preset_not_in=None, preset_not_starts_with=None, preset_starts_with=None, local_vars_configuration=None):  # noqa: E501
        ...
        self._and = _and
        self.apply_to_all_clusters = apply_to_all_clusters
        self.apply_to_all_clusters_not = apply_to_all_clusters_not
        self.clusters_every = clusters_every
        self.clusters_none = clusters_none
        self.clusters_some = clusters_some
        self.entity_type = entity_type
        self.entity_type_in = entity_type_in
        self.entity_type_not = entity_type_not
        self.entity_type_not_in = entity_type_not_in
        self.exec_failed_cluster_every = exec_failed_cluster_every
        self.exec_failed_cluster_none = exec_failed_cluster_none
        self.exec_failed_cluster_some = exec_failed_cluster_some
        self.filter_status = filter_status
        self.filter_status_in = filter_status_in
        self.filter_status_not = filter_status_not
        self.filter_status_not_in = filter_status_not_in
        self.id = id
