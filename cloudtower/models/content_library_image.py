...
class ContentLibraryImage(object):
    ...
    def __init__(self, clusters=None, created_at=None, description=None, elf_image_uuids=None, elf_images=None, entity_async_status=None, id=None, labels=None, name=None, path=None, size=None, vm_disks=None, vm_snapshots=None, vm_templates=None, local_vars_configuration=None):  # noqa: E501
        ...
        self.elf_image_uuids = elf_image_uuids
