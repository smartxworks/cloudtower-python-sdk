...
class CloudTowerApplicationOrderByInput(object):
    ...
    allowable_values = [ID_ASC, ID_DESC, INSTANCESTATUSES_ASC, INSTANCESTATUSES_DESC, NAME_ASC, NAME_DESC, PLACEMENTSITUATION_ASC, PLACEMENTSITUATION_DESC, PLACEMENTVERB_ASC, PLACEMENTVERB_DESC, RESOURCEVERSION_ASC, RESOURCEVERSION_DESC, STATE_ASC, STATE_DESC, TARGETPACKAGE_ASC, TARGETPACKAGE_DESC, VMSPEC_ASC, VMSPEC_DESC]  # noqa: E501
    ...
    def __init__(self, **kwargs):  # noqa: E501
        """CloudTowerApplicationOrderByInput - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CloudTowerApplicationOrderByInput):
            return False
