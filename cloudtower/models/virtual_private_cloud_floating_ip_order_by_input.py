...
class VirtualPrivateCloudFloatingIpOrderByInput(object):
    ...
    def __init__(self, **kwargs):  # noqa: E501
        """VirtualPrivateCloudFloatingIpOrderByInput - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VirtualPrivateCloudFloatingIpOrderByInput):
            return False
