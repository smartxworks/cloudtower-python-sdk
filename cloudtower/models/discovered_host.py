...
class DiscoveredHost(object):
    ...
    def __init__(self, all_flash=None, deployed=None, dimms=None, disks=None, host_ip=None, host_uuid=None, hostname=None, ifaces=None, ipmi_ip=None, is_os_in_raid1=None, product=None, serial=None, sockets=None, version=None, local_vars_configuration=None):  # noqa: E501
