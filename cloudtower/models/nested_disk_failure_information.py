...
class NestedDiskFailureInformation(object):
    ...
    def __init__(self, chunk_checksum_error=None, chunk_errflag=None, chunk_io_error=None, chunk_warnflag=None, iostat_latency=None, iostat_latency_ms=None, smart_check=None, local_vars_configuration=None):  # noqa: E501
        ...
        self.chunk_checksum_error = chunk_checksum_error
        self.chunk_errflag = chunk_errflag
        self.chunk_io_error = chunk_io_error
        self.chunk_warnflag = chunk_warnflag
        self.iostat_latency = iostat_latency
        self.iostat_latency_ms = iostat_latency_ms
        self.smart_check = smart_check
