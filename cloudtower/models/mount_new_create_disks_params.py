...
class MountNewCreateDisksParams(object):
    ...
    def __init__(self, max_bandwidth_policy=None, max_bandwidth=None, max_iops_policy=None, max_iops=None, vm_volume=None, index=None, key=None, bus=None, boot=None, local_vars_configuration=None):  # noqa: E501
