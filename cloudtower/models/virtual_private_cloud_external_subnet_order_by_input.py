...
class VirtualPrivateCloudExternalSubnetOrderByInput(object):
    ...
    allowable_values = [CIDR_ASC, CIDR_DESC, DESCRIPTION_ASC, DESCRIPTION_DESC, ENTITYASYNCSTATUS_ASC, ENTITYASYNCSTATUS_DESC, FLOATING_IP_CIDR_ASC, FLOATING_IP_CIDR_DESC, GATEWAY_ASC, GATEWAY_DESC, ID_ASC, ID_DESC, LOCAL_ID_ASC, LOCAL_ID_DESC, NAME_ASC, NAME_DESC, NAT_GATEWAY_CIDR_ASC, NAT_GATEWAY_CIDR_DESC, ROUTER_GATEWAY_CIDR_ASC, ROUTER_GATEWAY_CIDR_DESC]  # noqa: E501
    ...
    def __init__(self, **kwargs):  # noqa: E501
        """VirtualPrivateCloudExternalSubnetOrderByInput - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VirtualPrivateCloudExternalSubnetOrderByInput):
            return False
