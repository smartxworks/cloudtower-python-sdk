...
class VdsOrderByInput(object):
    ...
    allowable_values = [BOND_MODE_ASC, BOND_MODE_DESC, ENTITYASYNCSTATUS_ASC, ENTITYASYNCSTATUS_DESC, ID_ASC, ID_DESC, INTERNAL_ASC, INTERNAL_DESC, LOCAL_ID_ASC, LOCAL_ID_DESC, NAME_ASC, NAME_DESC, OVSBR_NAME_ASC, OVSBR_NAME_DESC, TYPE_ASC, TYPE_DESC, VLANS_NUM_ASC, VLANS_NUM_DESC, WORK_MODE_ASC, WORK_MODE_DESC]  # noqa: E501
