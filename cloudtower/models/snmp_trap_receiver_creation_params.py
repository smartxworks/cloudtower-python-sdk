...
class SnmpTrapReceiverCreationParams(object):
    ...
    def __init__(self, disabled=None, inform=None, engine_id=None, privacy_protocol=None, privacy_pass_phrase=None, auth_protocol=None, auth_pass_phrase=None, username=None, community=None, language_code=None, port=None, host=None, protocol=None, version=None, name=None, cluster_id=None, local_vars_configuration=None):  # noqa: E501
