...
class EntityFilter(object):
    ...
    def __init__(self, apply_to_all_clusters=None, clusters=None, entity_type=None, exclude_ids=None, exec_failed_cluster=None, filter_error=None, filter_status=None, id=None, ids=None, last_executed_at=None, name=None, preset=None, rules=None, local_vars_configuration=None):  # noqa: E501
        ...
        self.exec_failed_cluster = exec_failed_cluster
