...
class NicWhereInput(object):
    ...
    def __init__(self, _and=None, driver=None, driver_contains=None, driver_ends_with=None, driver_gt=None, driver_gte=None, driver_in=None, driver_lt=None, driver_lte=None, driver_not=None, driver_not_contains=None, driver_not_ends_with=None, driver_not_in=None, driver_not_starts_with=None, driver_starts_with=None, driver_state=None, driver_state_in=None, driver_state_not=None, driver_state_not_in=None, gateway_ip=None, gateway_ip_contains=None, gateway_ip_ends_with=None, gateway_ip_gt=None, gateway_ip_gte=None, gateway_ip_in=None, gateway_ip_lt=None, gateway_ip_lte=None, gateway_ip_not=None, gateway_ip_not_contains=None, gateway_ip_not_ends_with=None, gateway_ip_not_in=None, gateway_ip_not_starts_with=None, gateway_ip_starts_with=None, host=None, ibdev=None, ibdev_contains=None, ibdev_ends_with=None, ibdev_gt=None, ibdev_gte=None, ibdev_in=None, ibdev_lt=None, ibdev_lte=None, ibdev_not=None, ibdev_not_contains=None, ibdev_not_ends_with=None, ibdev_not_in=None, ibdev_not_starts_with=None, ibdev_starts_with=None, id=None, id_contains=None, id_ends_with=None, id_gt=None, id_gte=None, id_in=None, id_lt=None, id_lte=None, id_not=None, id_not_contains=None, id_not_ends_with=None, id_not_in=None, id_not_starts_with=None, id_starts_with=None, ip_address=None, ip_address_contains=None, ip_address_ends_with=None, ip_address_gt=None, ip_address_gte=None, ip_address_in=None, ip_address_lt=None, ip_address_lte=None, ip_address_not=None, ip_address_not_contains=None, ip_address_not_ends_with=None, ip_address_not_in=None, ip_address_not_starts_with=None, ip_address_starts_with=None, is_sriov=None, is_sriov_not=None, labels_every=None, labels_none=None, labels_some=None, local_id=None, local_id_contains=None, local_id_ends_with=None, local_id_gt=None, local_id_gte=None, local_id_in=None, local_id_lt=None, local_id_lte=None, local_id_not=None, local_id_not_contains=None, local_id_not_ends_with=None, local_id_not_in=None, local_id_not_starts_with=None, local_id_starts_with=None, mac_address=None, mac_address_contains=None, mac_address_ends_with=None, mac_address_gt=None, mac_address_gte=None, mac_address_in=None, mac_address_lt=None, mac_address_lte=None, mac_address_not=None, mac_address_not_contains=None, mac_address_not_ends_with=None, mac_address_not_in=None, mac_address_not_starts_with=None, mac_address_starts_with=None, max_vf_num=None, max_vf_num_gt=None, max_vf_num_gte=None, max_vf_num_in=None, max_vf_num_lt=None, max_vf_num_lte=None, max_vf_num_not=None, max_vf_num_not_in=None, model=None, model_contains=None, model_ends_with=None, model_gt=None, model_gte=None, model_in=None, model_lt=None, model_lte=None, model_not=None, model_not_contains=None, model_not_ends_with=None, model_not_in=None, model_not_starts_with=None, model_starts_with=None, mtu=None, mtu_gt=None, mtu_gte=None, mtu_in=None, mtu_lt=None, mtu_lte=None, mtu_not=None, mtu_not_in=None, name=None, name_contains=None, name_ends_with=None, name_gt=None, name_gte=None, name_in=None, name_lt=None, name_lte=None, name_not=None, name_not_contains=None, name_not_ends_with=None, name_not_in=None, name_not_starts_with=None, name_starts_with=None, nic_uuid=None, nic_uuid_contains=None, nic_uuid_ends_with=None, nic_uuid_gt=None, nic_uuid_gte=None, nic_uuid_in=None, nic_uuid_lt=None, nic_uuid_lte=None, nic_uuid_not=None, nic_uuid_not_contains=None, nic_uuid_not_ends_with=None, nic_uuid_not_in=None, nic_uuid_not_starts_with=None, nic_uuid_starts_with=None, _not=None, _or=None, physical=None, physical_not=None, rdma_enabled=None, rdma_enabled_not=None, running=None, running_not=None, speed=None, speed_gt=None, speed_gte=None, speed_in=None, speed_lt=None, speed_lte=None, speed_not=None, speed_not_in=None, subnet_mask=None, subnet_mask_contains=None, subnet_mask_ends_with=None, subnet_mask_gt=None, subnet_mask_gte=None, subnet_mask_in=None, subnet_mask_lt=None, subnet_mask_lte=None, subnet_mask_not=None, subnet_mask_not_contains=None, subnet_mask_not_ends_with=None, subnet_mask_not_in=None, subnet_mask_not_starts_with=None, subnet_mask_starts_with=None, total_vf_num=None, total_vf_num_gt=None, total_vf_num_gte=None, total_vf_num_in=None, total_vf_num_lt=None, total_vf_num_lte=None, total_vf_num_not=None, total_vf_num_not_in=None, type=None, type_in=None, type_not=None, type_not_in=None, up=None, up_not=None, used_vf_num=None, used_vf_num_gt=None, used_vf_num_gte=None, used_vf_num_in=None, used_vf_num_lt=None, used_vf_num_lte=None, used_vf_num_not=None, used_vf_num_not_in=None, vds=None, local_vars_configuration=None):  # noqa: E501
        ...
        self._and = _and
        self.driver = driver
        self.driver_contains = driver_contains
        self.driver_ends_with = driver_ends_with
        self.driver_gt = driver_gt
        self.driver_gte = driver_gte
        self.driver_in = driver_in
        self.driver_lt = driver_lt
        self.driver_lte = driver_lte
        self.driver_not = driver_not
        self.driver_not_contains = driver_not_contains
        self.driver_not_ends_with = driver_not_ends_with
        self.driver_not_in = driver_not_in
        self.driver_not_starts_with = driver_not_starts_with
        self.driver_starts_with = driver_starts_with
        self.driver_state = driver_state
        self.driver_state_in = driver_state_in
        self.driver_state_not = driver_state_not
        self.driver_state_not_in = driver_state_not_in
        ...
        self.host = host
        self.ibdev = ibdev
        self.ibdev_contains = ibdev_contains
        self.ibdev_ends_with = ibdev_ends_with
        self.ibdev_gt = ibdev_gt
        self.ibdev_gte = ibdev_gte
        self.ibdev_in = ibdev_in
        self.ibdev_lt = ibdev_lt
        self.ibdev_lte = ibdev_lte
        self.ibdev_not = ibdev_not
        self.ibdev_not_contains = ibdev_not_contains
        self.ibdev_not_ends_with = ibdev_not_ends_with
        self.ibdev_not_in = ibdev_not_in
        self.ibdev_not_starts_with = ibdev_not_starts_with
        self.ibdev_starts_with = ibdev_starts_with
        self.id = id
        ...
        self.ip_address_contains = ip_address_contains
        self.ip_address_ends_with = ip_address_ends_with
        self.ip_address_gt = ip_address_gt
        self.ip_address_gte = ip_address_gte
        self.ip_address_in = ip_address_in
        self.ip_address_lt = ip_address_lt
        self.ip_address_lte = ip_address_lte
        self.ip_address_not = ip_address_not
        self.ip_address_not_contains = ip_address_not_contains
        self.ip_address_not_ends_with = ip_address_not_ends_with
        self.ip_address_not_in = ip_address_not_in
        self.ip_address_not_starts_with = ip_address_not_starts_with
        self.ip_address_starts_with = ip_address_starts_with
        self.is_sriov = is_sriov
        self.is_sriov_not = is_sriov_not
        ...
        self.mac_address_contains = mac_address_contains
        self.mac_address_ends_with = mac_address_ends_with
        self.mac_address_gt = mac_address_gt
        self.mac_address_gte = mac_address_gte
        self.mac_address_in = mac_address_in
        self.mac_address_lt = mac_address_lt
        self.mac_address_lte = mac_address_lte
        self.mac_address_not = mac_address_not
        self.mac_address_not_contains = mac_address_not_contains
        self.mac_address_not_ends_with = mac_address_not_ends_with
        self.mac_address_not_in = mac_address_not_in
        self.mac_address_not_starts_with = mac_address_not_starts_with
        self.mac_address_starts_with = mac_address_starts_with
        self.max_vf_num = max_vf_num
        self.max_vf_num_gt = max_vf_num_gt
        self.max_vf_num_gte = max_vf_num_gte
        self.max_vf_num_in = max_vf_num_in
        self.max_vf_num_lt = max_vf_num_lt
        self.max_vf_num_lte = max_vf_num_lte
        self.max_vf_num_not = max_vf_num_not
        self.max_vf_num_not_in = max_vf_num_not_in
        self.model = model
        ...
        self.mtu = mtu
        self.mtu_gt = mtu_gt
        self.mtu_gte = mtu_gte
        self.mtu_in = mtu_in
        self.mtu_lt = mtu_lt
        self.mtu_lte = mtu_lte
        self.mtu_not = mtu_not
        self.mtu_not_in = mtu_not_in
        self.name = name
        ...
        self.nic_uuid_contains = nic_uuid_contains
        self.nic_uuid_ends_with = nic_uuid_ends_with
        self.nic_uuid_gt = nic_uuid_gt
        self.nic_uuid_gte = nic_uuid_gte
        self.nic_uuid_in = nic_uuid_in
        self.nic_uuid_lt = nic_uuid_lt
        self.nic_uuid_lte = nic_uuid_lte
        self.nic_uuid_not = nic_uuid_not
        self.nic_uuid_not_contains = nic_uuid_not_contains
        self.nic_uuid_not_ends_with = nic_uuid_not_ends_with
        self.nic_uuid_not_in = nic_uuid_not_in
        self.nic_uuid_not_starts_with = nic_uuid_not_starts_with
        self.nic_uuid_starts_with = nic_uuid_starts_with
        self._not = _not
        self._or = _or
        self.physical = physical
        self.physical_not = physical_not
        self.rdma_enabled = rdma_enabled
        self.rdma_enabled_not = rdma_enabled_not
        self.running = running
        self.running_not = running_not
        self.speed = speed
        self.speed_gt = speed_gt
        self.speed_gte = speed_gte
        self.speed_in = speed_in
        self.speed_lt = speed_lt
        self.speed_lte = speed_lte
        self.speed_not = speed_not
        self.speed_not_in = speed_not_in
        ...
        self.total_vf_num_gt = total_vf_num_gt
        self.total_vf_num_gte = total_vf_num_gte
        self.total_vf_num_in = total_vf_num_in
        self.total_vf_num_lt = total_vf_num_lt
        self.total_vf_num_lte = total_vf_num_lte
        self.total_vf_num_not = total_vf_num_not
        self.total_vf_num_not_in = total_vf_num_not_in
        self.type = type
        ...
        self.used_vf_num_gt = used_vf_num_gt
        self.used_vf_num_gte = used_vf_num_gte
        self.used_vf_num_in = used_vf_num_in
        self.used_vf_num_lt = used_vf_num_lt
        self.used_vf_num_lte = used_vf_num_lte
        self.used_vf_num_not = used_vf_num_not
        self.used_vf_num_not_in = used_vf_num_not_in
        self.vds = vds
