...
class IscsiConnectionWhereInput(object):
    ...
    def __init__(self, _and=None, client_port=None, client_port_gt=None, client_port_gte=None, client_port_in=None, client_port_lt=None, client_port_lte=None, client_port_not=None, client_port_not_in=None, cluster=None, host=None, id=None, id_contains=None, id_ends_with=None, id_gt=None, id_gte=None, id_in=None, id_lt=None, id_lte=None, id_not=None, id_not_contains=None, id_not_ends_with=None, id_not_in=None, id_not_starts_with=None, id_starts_with=None, initiator_ip=None, initiator_ip_contains=None, initiator_ip_ends_with=None, initiator_ip_gt=None, initiator_ip_gte=None, initiator_ip_in=None, initiator_ip_lt=None, initiator_ip_lte=None, initiator_ip_not=None, initiator_ip_not_contains=None, initiator_ip_not_ends_with=None, initiator_ip_not_in=None, initiator_ip_not_starts_with=None, initiator_ip_starts_with=None, iscsi_target=None, _not=None, nvmf_subsystem=None, _or=None, type=None, type_in=None, type_not=None, type_not_in=None, local_vars_configuration=None):  # noqa: E501
        ...
        self.client_port_gt = client_port_gt
        self.client_port_gte = client_port_gte
        self.client_port_in = client_port_in
        self.client_port_lt = client_port_lt
        self.client_port_lte = client_port_lte
        self.client_port_not = client_port_not
        self.client_port_not_in = client_port_not_in
        ...
        self.initiator_ip_contains = initiator_ip_contains
        self.initiator_ip_ends_with = initiator_ip_ends_with
        self.initiator_ip_gt = initiator_ip_gt
        self.initiator_ip_gte = initiator_ip_gte
        self.initiator_ip_in = initiator_ip_in
        self.initiator_ip_lt = initiator_ip_lt
        self.initiator_ip_lte = initiator_ip_lte
        self.initiator_ip_not = initiator_ip_not
        self.initiator_ip_not_contains = initiator_ip_not_contains
        self.initiator_ip_not_ends_with = initiator_ip_not_ends_with
        self.initiator_ip_not_in = initiator_ip_not_in
        self.initiator_ip_not_starts_with = initiator_ip_not_starts_with
        self.initiator_ip_starts_with = initiator_ip_starts_with
