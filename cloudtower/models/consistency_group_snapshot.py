...
class ConsistencyGroupSnapshot(object):
    ...
    def __init__(self, consistency_group=None, entity_async_status=None, id=None, iscsi_lun_snapshots=None, labels=None, local_created_at=None, local_id=None, name=None, nvmf_namespace_snapshots=None, unique_size=None, local_vars_configuration=None):  # noqa: E501
