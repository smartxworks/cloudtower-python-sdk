...
class VirtualPrivateCloudExternalSubnetGroupOrderByInput(object):
    ...
    allowable_values = [DESCRIPTION_ASC, DESCRIPTION_DESC, ENTITYASYNCSTATUS_ASC, ENTITYASYNCSTATUS_DESC, EXCLUSIVE_ASC, EXCLUSIVE_DESC, EXTERNAL_SUBNETS_SPEC_ASC, EXTERNAL_SUBNETS_SPEC_DESC, ID_ASC, ID_DESC, LOCAL_ID_ASC, LOCAL_ID_DESC, NAME_ASC, NAME_DESC, SHARED_IN_EDGE_GATEWAY_GROUP_ASC, SHARED_IN_EDGE_GATEWAY_GROUP_DESC]  # noqa: E501
    ...
    def __init__(self, **kwargs):  # noqa: E501
        """VirtualPrivateCloudExternalSubnetGroupOrderByInput - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VirtualPrivateCloudExternalSubnetGroupOrderByInput):
            return False
