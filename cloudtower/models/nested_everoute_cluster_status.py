...
class NestedEverouteClusterStatus(object):
    ...
    def __init__(self, agents=None, conditions=None, controllers=None, message=None, phase=None, reason=None, retry_count=None, version=None, local_vars_configuration=None):  # noqa: E501
