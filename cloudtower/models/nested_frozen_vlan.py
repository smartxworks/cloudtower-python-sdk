...
class NestedFrozenVlan(object):
    ...
    def __init__(self, name=None, vds_ovs=None, vlan_id=None, vlan_local_id=None, local_vars_configuration=None):  # noqa: E501
        ...
        self.name = name
        self.vds_ovs = vds_ovs
        self.vlan_id = vlan_id
        self.vlan_local_id = vlan_local_id
