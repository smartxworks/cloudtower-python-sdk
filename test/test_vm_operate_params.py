...
import cloudtower
from cloudtower.models.vm_operate_params import VmOperateParams  # noqa: E501
from cloudtower.rest import ApiException

class TestVmOperateParams(unittest.TestCase):
    """VmOperateParams unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test VmOperateParams
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = cloudtower.models.vm_operate_params.VmOperateParams()  # noqa: E501
        if include_optional :
            return VmOperateParams(
